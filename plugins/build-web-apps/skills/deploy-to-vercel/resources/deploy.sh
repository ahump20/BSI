...
# NOTE: This endpoint is from the original OpenAI bundle and may not be
# available outside that platform. Prefer `vercel deploy` (Vercel CLI) or
# the Vercel MCP server for Claude Code deployments.
DEPLOY_ENDPOINT="${VERCEL_DEPLOY_ENDPOINT:-https://vercel.com/api/v13/deployments}"
