...
| `BSI_CHATGPT_CACHE` | `9752...` | BSI_PREFIX ✓ | ChatGPT App | *(keep as-is)* |
...
| `BSI_PORTAL_CACHE` | `edab...` | BSI_PREFIX ✓ | Portal Agent | *(keep as-is)* |
| `CFB_CACHE` | `9635...` | UPPERCASE | bsi-cfb-ai | `BSI_CFB_CACHE` |
| `BLAZE_KV` | `1b4e...` | UPPERCASE | Legacy? | **DELETE** |
| `BSI_PREVIEW_CACHE` | `3815...` | BSI_PREFIX ✓ | Preview env | *(keep as-is)* |
...
*Generated during Cloudflare Infrastructure Audit - January 7, 2026*
