        ...
        <CardContent>
          ...
          <div className="flex items-center justify-between mb-6 px-4">
            <div className="flex items-center gap-3">
              <TeamCircle logo={game.teams.away.logo} abbreviation={game.teams.away.abbreviation} size="w-12 h-12" textSize="text-sm" ranking={game.teams.away.ranking} />
              <div>
            ...
            <div className="flex items-center gap-3 flex-row-reverse">
              <TeamCircle logo={game.teams.home.logo} abbreviation={game.teams.home.abbreviation} size="w-12 h-12" textSize="text-sm" ranking={game.teams.home.ranking} />
