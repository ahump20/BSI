            ...
            <ScrollReveal>
              <div className="text-center max-w-3xl mx-auto">
                ...
                <p className="text-lg md:text-xl text-text-secondary max-w-2xl mx-auto">
                  ...
                  withdrawing from the transfer portal. Updated continuously throughout the portal
                  window.
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal>
              <div className="text-center mb-12">
                ...
                <p className="text-text-secondary max-w-2xl mx-auto">
                  D1Baseball charges $145.99/year for editorial coverage—not a real database. We
        ...
        <Section className="py-8 border-t border-border-subtle">
          <Container>
            <div className="text-center text-sm text-text-muted">
              ...
              <p>
                Data sourced from official NCAA portal filings, D1Baseball, and verified social
                media. Updated every 5 minutes during active windows.
              </p>
