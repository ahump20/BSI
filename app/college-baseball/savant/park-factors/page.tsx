          ...
          <Container size="wide">
            ...
            <ScrollReveal direction="up">
              <nav className="flex items-center gap-2 text-sm mb-6">
                ...
                <span className="text-bsi-dust/50">/</span>
                <span className="text-bsi-dust">Park Factors</span>
              </nav>
            </ScrollReveal>
            ...
            <ScrollReveal direction="up" delay={50}>
              <div className="mb-10">
                ...
                <h1 className="font-display text-3xl md:text-5xl font-bold uppercase tracking-wider text-bsi-bone">
                  Park <span className="text-[var(--bsi-primary)]">Factors</span>
                </h1>
            ...
            <ScrollReveal direction="up" delay={100}>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-10">
                <Card padding="md">
                  <span className="text-xs text-[var(--bsi-primary)] font-display uppercase tracking-widest block mb-1">
                    Hitter-Friendly
                  </span>
                ...
                <Card padding="md">
                  <span className="text-xs text-bsi-dust/50 font-display uppercase tracking-widest block mb-1">
                    Neutral
                  </span>
                  <p className="text-[11px] text-bsi-dust/50 leading-relaxed">
  ...
  return (
    <Card padding="none" className="overflow-hidden">
      <div className="px-5 py-4 border-b border-[rgba(140,98,57,0.3)]">
        <div className="h-5 w-32 bg-[#161616] rounded-sm animate-pulse" />
      </div>
      {Array.from({ length: 8 }).map((_, i) => (
        <div key={i} className="px-5 py-3 flex items-center gap-4 border-b border-[rgba(140,98,57,0.3)]">
          <div className="h-4 w-32 bg-[#161616] rounded-sm animate-pulse" />
          <div className="h-4 w-24 bg-[#111111] rounded-sm animate-pulse hidden sm:block" />
          <div className="h-4 w-16 bg-[#111111] rounded-sm animate-pulse ml-auto" />
        </div>
      ))}
    </Card>
  );
