        ...
        <Section padding="sm" className="border-b border-border">
          <Container>
            <nav className="flex items-center gap-2 text-sm">
              ...
              <span className="text-[rgba(196,184,165,0.35)]">/</span>
              <span className="text-[var(--bsi-dust)]">Texas vs Texas State</span>
            </nav>
          </Container>
        </Section>
            ...
            <ScrollReveal direction="up">
              <div className="max-w-3xl">
                <div className="flex flex-wrap items-center gap-3 mb-4">
                  ...
                  <span className="font-mono text-xs text-[rgba(196,184,165,0.35)]">First Road Win</span>
                </div>
          ...
          <Container>
            <ScrollReveal direction="up">
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="font-mono text-xs text-[rgba(196,184,165,0.35)]">Tuesday &middot; Mar 10</span>
              </div>
          ...
          <Container size="narrow">
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-6 pt-2">
                ...
                <Link href="/college-baseball/editorial/week-4-preview" className="font-display text-[13px] uppercase tracking-widest text-[var(--bsi-primary)] hover:opacity-70 transition-opacity">
                  Week 4 Preview &rarr;
                </Link>
              </div>
            </div>
