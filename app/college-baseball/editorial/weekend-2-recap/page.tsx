        ...
        <Section padding="sm" className="border-b border-[var(--border-vintage)]">
          <Container>
            <nav className="flex items-center gap-2 text-sm">
              ...
              <span className="text-[rgba(196,184,165,0.35)]">/</span>
              <span className="text-[var(--bsi-bone)]">Weekend 2 Recap</span>
            </nav>
          </Container>
        </Section>
            ...
            <ScrollReveal direction="up">
              <div className="max-w-3xl">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <span className="text-[rgba(196,184,165,0.35)] text-sm">February 24, 2026</span>
                  <span className="text-[rgba(196,184,165,0.35)] text-sm">15 min read</span>
                </div>
                <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold uppercase tracking-wide mb-6">
                  The No. 1 Showed Up.{' '}
                  <span className="text-[var(--bsi-primary)]">The Rest Got Sorted.</span>
                </h1>
        ...
        <Section padding="lg">
          <Container size="narrow">
            ...
            <ScrollReveal direction="up" delay={50}>
              <div className="font-serif text-lg leading-[1.78] text-[var(--bsi-dust)] space-y-6">
                <p>
                  Two players hit for the cycle this weekend. Both deserve full paragraphs. But the nod goes to Arkansas&rsquo;s <strong className="text-[var(--bsi-bone)] font-semibold">Cam Kozeal</strong> because of what happened around his.
                </p>
                <p>
                  Kozeal went 4-for-5 with a double, triple, home run, and single in Saturday&rsquo;s game against Xavier &mdash; the first Razorback to hit for the cycle since Dylan Leach in 2022. The game itself was a 7&ndash;6 walk-off win, with <strong className="text-[var(--bsi-bone)] font-semibold">Kuhio Aloy</strong> delivering the game-winning RBI single. That context matters. Kozeal didn&rsquo;t compile stats in a blowout. He hit for the cycle in a one-run game that Arkansas had to walk off to win. His week-long line &mdash; 8-for-17, 2 home runs, 7 RBI &mdash; confirmed that the cycle wasn&rsquo;t an anomaly but the peak of a player locked into every at-bat.
                </p>
                <p>
        ...
        <Section padding="lg" background="charcoal">
          <Container size="narrow">
            ...
            <ScrollReveal direction="up" delay={50}>
              <div className="font-serif text-lg leading-[1.78] text-[var(--bsi-dust)] space-y-6">
                <p>
                  The <strong className="text-[var(--bsi-bone)] font-semibold">Amegy Bank College Baseball Series returns to Globe Life Field</strong> (Feb. 27&ndash;Mar. 1) with a round-robin featuring No. 1 UCLA, No. 4 Mississippi State, No. 20 Tennessee, No. 23 Texas A&amp;M, Arizona State, and Virginia Tech. The matchups that matter most:
                </p>
                <p>
          ...
          <Container size="narrow">
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-6 pt-2">
                ...
                <Link href="/college-baseball/editorial/week-1-recap" className="font-display text-[13px] uppercase tracking-widest text-[rgba(196,184,165,0.35)] hover:text-[var(--bsi-primary)] transition-colors">
                  Week 1 Recap &rarr;
                </Link>
              </div>
            </div>
