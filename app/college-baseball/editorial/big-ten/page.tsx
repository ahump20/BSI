...
const BIGTEN_TEAMS: TeamEntry[] = [
  ...
  { name: 'Michigan', slug: 'michigan', mascot: 'Wolverines', tier: 'Dark Horse' },
  { name: 'Iowa', slug: 'iowa', mascot: 'Hawkeyes', tier: 'Dark Horse' },
  { name: 'Indiana', slug: 'indiana', mascot: 'Hoosiers', tier: 'Bubble' },
  { name: 'Penn State', slug: 'penn-state', mascot: 'Nittany Lions', tier: 'Bubble' },
  { name: 'Nebraska', slug: 'nebraska', mascot: 'Cornhuskers', tier: 'Bubble' },
          ...
          <Container>
            <nav className="flex items-center gap-2 text-sm">
              <Link
                ...
                className="text-[rgba(196,184,165,0.35)] hover:text-[#6B8CAE] transition-colors"
              >
                College Baseball
              </Link>
              ...
              <span className="text-[rgba(196,184,165,0.35)]">/</span>
              <span className="text-[var(--bsi-bone)]">Big Ten</span>
            </nav>
          </Container>
        </Section>
          ...
          <Container>
            ...
            <ScrollReveal direction="up" delay={100}>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="bg-[var(--surface-press-box)] border border-[var(--border-vintage)] rounded-sm p-4 text-center">
                  <div className="font-display text-3xl font-bold text-[rgba(196,184,165,0.35)]">8</div>
                  <div className="text-[rgba(196,184,165,0.35)] text-xs uppercase tracking-wider mt-1">
                    Bubble Teams
                  </div>
                </div>
        ...
        <Section padding="lg" borderTop>
          <Container>
            ...
            <ConferenceTeamGrid
              teams={BIGTEN_TEAMS}
              conference="Big Ten"
              hoverColor="rgba(107, 140, 174, 0.4)"
            />
          </Container>
        </Section>
