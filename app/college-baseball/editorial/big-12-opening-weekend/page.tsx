        ...
        <Section padding="sm" className="border-b border-border">
          <Container>
            <nav className="flex items-center gap-2 text-sm">
              ...
              <span className="text-[rgba(196,184,165,0.35)]">/</span>
              <span className="text-[var(--bsi-bone)]">Big 12 Opening Weekend</span>
            </nav>
          </Container>
        </Section>
            ...
            <ScrollReveal direction="up">
              <div className="max-w-3xl">
                ...
                <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold uppercase tracking-wide mb-6">
                  ...
                  <span className="text-[var(--bsi-primary)]">14 Teams, Real Depth</span>
                </h1>
              ...
              {big12Matchups.map((m, i) => (
                <ScrollReveal key={m.at} direction="up" delay={Math.min(i * 50, 250)}>
                  <Card variant="default" padding="md" className="h-full">
                    <div className="font-display text-sm font-bold uppercase tracking-wide text-[var(--bsi-bone)] mb-1">{m.at}</div>
          ...
          <Container size="narrow">
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-6 pt-2">
                ...
                <Link href="/college-baseball/editorial/big-12" className="font-display text-[13px] uppercase tracking-widest text-[var(--bsi-primary)] hover:opacity-70 transition-opacity">
