                  ...
                  <tbody>
                    {STARTS_2026.map((g) => (
                      <tr key={g.game} className="border-b border-[var(--border-vintage)]">
                        ...
                        <td className="py-3 px-3 text-[var(--bsi-bone)] text-sm text-center font-mono">{g.ip}</td>
                        <td className="py-3 px-3 text-[var(--bsi-bone)] text-sm text-center">{g.h}</td>
                        <td className="py-3 px-3 text-[var(--bsi-primary)] font-bold text-sm text-center">{g.er}</td>
                        ...
                        <td className="py-3 px-3 text-[rgba(196,184,165,0.5)] text-sm text-center font-mono">{g.pitches}</td>
                    ...
                    <tr className="border-t-2 border-[var(--bsi-primary)]/30 bg-[var(--surface-press-box)]">
                      <td className="py-3 px-3 text-[var(--bsi-bone)] text-sm font-bold" colSpan={3}>2026 Total (2 starts)</td>
                      <td className="py-3 px-3 text-[var(--bsi-bone)] text-sm text-center font-mono font-bold">14.0</td>
                      <td className="py-3 px-3 text-[var(--bsi-bone)] text-sm text-center font-bold">6</td>
                      <td className="py-3 px-3 text-[var(--bsi-primary)] font-bold text-sm text-center">0</td>
                      <td className="py-3 px-3 text-[var(--bsi-bone)] text-sm text-center font-bold">2</td>
                      <td className="py-3 px-3 text-[var(--bsi-bone)] text-sm text-center font-bold">17</td>
                      <td className="py-3 px-3 text-[rgba(196,184,165,0.5)] text-sm text-center">&mdash;</td>
                      <td className="py-3 px-3 text-[rgba(196,184,165,0.5)] text-sm italic">0.00 ERA, 0.57 WHIP</td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <Container size="narrow">
            <ScrollReveal direction="up">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                <div className="p-3 rounded-sm bg-[var(--surface-press-box)] border border-[var(--border-vintage)]">
                  <span className="text-[10px] text-[rgba(196,184,165,0.35)] block uppercase tracking-widest">ERA</span>
                  <span className="font-mono text-2xl font-bold text-[var(--bsi-primary)]">{FRESHMAN_STATS.era}</span>
                </div>
                <div className="p-3 rounded-sm bg-[var(--surface-press-box)] border border-[var(--border-vintage)]">
                  <span className="text-[10px] text-[rgba(196,184,165,0.35)] block uppercase tracking-widest">IP</span>
                  <span className="font-mono text-2xl font-bold text-[var(--bsi-bone)]">{FRESHMAN_STATS.ip}</span>
                </div>
                <div className="p-3 rounded-sm bg-[var(--surface-press-box)] border border-[var(--border-vintage)]">
                  <span className="text-[10px] text-[rgba(196,184,165,0.35)] block uppercase tracking-widest">Strikeouts</span>
                  <span className="font-mono text-2xl font-bold text-[var(--bsi-bone)]">{FRESHMAN_STATS.so}</span>
                </div>
                <div className="p-3 rounded-sm bg-[var(--surface-press-box)] border border-[var(--border-vintage)]">
                  <span className="text-[10px] text-[rgba(196,184,165,0.35)] block uppercase tracking-widest">Saves</span>
                  <span className="font-mono text-2xl font-bold text-[var(--bsi-primary)]">{FRESHMAN_STATS.sv}</span>
                </div>
              </div>
          ...
          <Container size="narrow">
            <ScrollReveal direction="up">
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-8">
                <Link href="/college-baseball/editorial/texas-week-2-recap" className="group block p-4 rounded-sm border border-[var(--border-vintage)] bg-[var(--surface-press-box)] hover:border-[var(--bsi-primary)]/30 transition-colors">
                ...
                <Link href="/college-baseball/editorial/texas-2026" className="group block p-4 rounded-sm border border-[var(--border-vintage)] bg-[var(--surface-press-box)] hover:border-[var(--bsi-primary)]/30 transition-colors">
