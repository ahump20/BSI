...
const seoConfig = {
  title: 'SEC Opening Weekend Preview 2026: 13 Ranked Teams',
  description: '13 ranked teams. Texas and Oklahoma in year two of the SEC era. The deepest conference in college baseball opens play. Full series-by-series preview.',
  datePublished: '2026-02-12',
  slug: '/college-baseball/editorial/sec-opening-weekend',
  image: '/images/og/cbb-sec-opening-weekend.png',
  sport: 'College Baseball',
  ogTitle: 'SEC Baseball Opening Weekend 2026 | Blaze Sports Intel',
};
        ...
        <Section padding="sm" className="border-b border-[var(--border-vintage)]">
          <Container>
            <nav className="flex items-center gap-2 text-sm">
              ...
              <span className="text-[rgba(196,184,165,0.35)]">/</span>
              <span className="text-[var(--bsi-bone)]">SEC Opening Weekend</span>
            </nav>
          </Container>
        </Section>
            ...
            <ScrollReveal direction="up">
              <div className="max-w-3xl">
                ...
                <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold uppercase tracking-wide mb-6">
                  SEC Opening Weekend:{' '}
                  <span className="text-[var(--bsi-primary)]">The Deepest Conference in America Opens Play</span>
                </h1>
                ...
                <ScrollReveal key={m.at} direction="up" delay={Math.min(i * 50, 300)}>
                  <Card variant="default" padding="md" className="h-full">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="font-display text-sm font-bold uppercase tracking-wide text-[var(--bsi-bone)]">{m.at}</span>
                    </div>
                    <div className="font-mono text-[10px] uppercase tracking-wider text-[#C9A227] mb-2">
                      {m.away} @ {m.at} &middot; {m.date}
                    </div>
                    <p className="font-serif text-sm text-[rgba(196,184,165,0.5)] leading-relaxed mb-3">{m.capsule}</p>
                    <div className="text-[10px] uppercase tracking-wider text-[rgba(196,184,165,0.35)]">
