          ...
          <Container size="narrow">
            <ScrollReveal direction="up">
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-8">
                <Link href="/college-baseball/editorial/weekend-2-recap" className="group block p-4 rounded-sm border border-border-subtle bg-surface-light hover:border-burnt-orange/30 transition-colors">
                  <span className="text-[10px] text-text-muted uppercase tracking-widest">Related</span>
                  <p className="text-sm font-display uppercase tracking-wide text-text-primary group-hover:text-burnt-orange transition-colors mt-1">
                    Weekend 2 Recap: Full National Breakdown
                  </p>
                </Link>
                <Link href="/college-baseball/editorial/ucla-2026" className="group block p-4 rounded-sm border border-border-subtle bg-surface-light hover:border-burnt-orange/30 transition-colors">
