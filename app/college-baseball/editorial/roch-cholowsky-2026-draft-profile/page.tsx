                ...
                <table className="w-full">
                  ...
                  <tbody>
                    ...
                    <tr className="border-t-2 border-[var(--bsi-primary)]/30 bg-[var(--surface-press-box)]">
                      <td className="py-3 px-3 text-[var(--bsi-bone)] text-sm font-bold" colSpan={2}>Series Total</td>
                      <td className="py-3 px-3 text-[var(--bsi-bone)] text-sm text-center font-bold">12</td>
                      <td className="py-3 px-3 text-[var(--bsi-bone)] text-sm text-center font-bold">5</td>
                      <td className="py-3 px-3 text-[var(--bsi-primary)] font-bold text-sm text-center">3</td>
                      <td className="py-3 px-3 text-[var(--bsi-bone)] text-sm text-center font-bold">7</td>
                      ...
                      <td className="py-3 px-3 text-[rgba(196,184,165,0.5)] text-sm italic">UCLA swept 30-8</td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <Container size="narrow">
            <ScrollReveal direction="up">
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-8">
                <Link href="/college-baseball/editorial/weekend-2-recap" className="group block p-4 rounded-sm border border-[var(--border-vintage)] bg-[var(--surface-press-box)] hover:border-[var(--bsi-primary)]/30 transition-colors">
                ...
                <Link href="/college-baseball/editorial/ucla-2026" className="group block p-4 rounded-sm border border-[var(--border-vintage)] bg-[var(--surface-press-box)] hover:border-[var(--bsi-primary)]/30 transition-colors">
