        ...
        <Section padding="sm" className="border-b border-border">
          <Container>
            <nav className="flex items-center gap-2 text-sm">
              ...
              <span className="text-[rgba(196,184,165,0.35)]">/</span>
              <span className="text-[var(--bsi-bone)]">National Opening Weekend</span>
            </nav>
          </Container>
        </Section>
            ...
            <ScrollReveal direction="up">
              <div className="max-w-3xl">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <span className="text-[rgba(196,184,165,0.35)] text-sm">February 13, 2026</span>
                ...
                <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold uppercase tracking-wide mb-6">
                  ...
                  <span className="text-[var(--bsi-primary)]">The Season Starts Now</span>
                </h1>
                ...
                <ScrollReveal key={s.matchup} direction="up" delay={Math.min(i * 50, 250)}>
                  <Card variant="default" padding="md">
                    <div className="flex flex-wrap items-center gap-3 mb-2">
                      <span className="font-display text-sm font-bold uppercase tracking-wide text-[var(--bsi-bone)]">{s.matchup}</span>
                      <Badge variant="outline">{s.conf}</Badge>
                    </div>
                    <p className="font-serif text-sm text-[rgba(196,184,165,0.5)] leading-relaxed">{s.capsule}</p>
                  </Card>
                </ScrollReveal>
              ))}
            </div>
              ...
              {confPreviews.map((c, i) => (
                <ScrollReveal key={c.name} direction="up" delay={i * 60}>
                  <Link href={c.href} className="block group">
                    <Card variant="default" padding="md" className="h-full hover:border-[rgba(140,98,57,0.5)] transition-all relative overflow-hidden">
                      ...
                      <div className="mt-1">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <div className="flex gap-3 text-xs text-[rgba(196,184,165,0.35)]">
                            <span>{c.ranked} ranked</span>
                            <span>{c.teams} teams</span>
                          </div>
                        </div>
                        <p className="font-serif text-sm text-[rgba(196,184,165,0.5)] leading-relaxed">{c.note}</p>
