        ...
        <Section padding="sm" className="border-b border-white/10">
          <Container>
            <nav className="flex items-center gap-2 text-sm">
              ...
              <span className="text-white/20">/</span>
              <span className="text-white/70">Texas Week 2</span>
            </nav>
          </Container>
        </Section>
          ...
          <Container size="narrow">
            <ScrollReveal direction="up">
              ...
              <p className="font-serif text-lg leading-relaxed text-white/70 mb-6">
                The headline moment was Robbins&rsquo; cycle on Saturday &mdash; the first by a Longhorn since CJ Hinojosa against Kansas State on April 18, 2015. But the structural takeaway lives in the pitching: <strong className="text-white/90">1.53 staff ERA, 0.86 WHIP, and a rotation that has thrown 14 straight scoreless innings on Sundays</strong> through Dylan Volantis.
              </p>
          ...
          <Container>
            <ScrollReveal direction="up">
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="font-mono text-xs text-white/30">Friday &middot; Feb 20</span>
              </div>
          ...
          <Container>
            <ScrollReveal direction="up">
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="font-mono text-xs text-white/30">Saturday &middot; Feb 21</span>
              </div>
            ...
            <Container size="narrow">
              ...
              <ScrollReveal direction="up" delay={150}>
                <div className="bg-[#C9A227]/8 border border-[#C9A227]/20 rounded p-6 my-8">
                  ...
                  <p className="font-serif text-sm text-white/60 leading-relaxed mb-3">
                  ...
                  <p className="font-serif text-sm text-white/40 leading-relaxed">
              ...
              <ScrollReveal direction="up" delay={200}>
                <div className="font-serif text-lg leading-[1.78] text-white/70 space-y-4">
                  <p>
          ...
          <Container>
            <ScrollReveal direction="up">
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="font-mono text-xs text-white/30">Sunday &middot; Feb 22</span>
              </div>
          ...
          <Container size="narrow">
            <ScrollReveal direction="up">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-8">
                <div className="bg-white/[0.03] border border-white/[0.06] rounded p-4 text-center">
                  <div className="font-display text-[10px] uppercase tracking-[3px] text-white/30 mb-1">Team BA</div>
                  <div className="font-display text-2xl font-bold text-burnt-orange">.321</div>
                </div>
                <div className="bg-white/[0.03] border border-white/[0.06] rounded p-4 text-center">
                  <div className="font-display text-[10px] uppercase tracking-[3px] text-white/30 mb-1">Team OPS</div>
                  <div className="font-display text-2xl font-bold text-burnt-orange">.986</div>
                </div>
                <div className="bg-white/[0.03] border border-white/[0.06] rounded p-4 text-center">
                  <div className="font-display text-[10px] uppercase tracking-[3px] text-white/30 mb-1">Staff ERA</div>
                  <div className="font-display text-2xl font-bold text-burnt-orange">1.53</div>
                </div>
                <div className="bg-white/[0.03] border border-white/[0.06] rounded p-4 text-center">
                  <div className="font-display text-[10px] uppercase tracking-[3px] text-white/30 mb-1">WHIP</div>
              ...
              <div className="font-serif text-lg leading-[1.78] text-white/80 space-y-6">
                <p>
                  Through seven games, the run differential is <strong className="text-white/90">56-13 (+43)</strong>. Texas has outscored opponents by more than four runs per game on average, and the pitching staff hasn&rsquo;t allowed more than four runs in any single contest.
                </p>

                <div className="space-y-4">
                  <h3 className="font-display text-sm uppercase tracking-wider text-white/60 mb-3">Individual Leaders</h3>

                  <div className="bg-white/[0.03] border border-white/[0.06] rounded p-4">
                    <div className="font-display text-sm font-semibold uppercase tracking-wide text-white mb-1">Ethan Mendoza</div>
                    <div className="font-mono text-xs text-burnt-orange mb-1">.462 AVG &middot; 12 H &middot; 3 HR &middot; 9 RBI &middot; 1.375 OPS</div>
                    <div className="font-mono text-[11px] text-white/40">Best bat in the lineup through two weekends. Hitting for average and power with no platoon weakness.</div>
                  </div>

                  <div className="bg-white/[0.03] border border-white/[0.06] rounded p-4">
                    <div className="font-display text-sm font-semibold uppercase tracking-wide text-white mb-1">Carson Tinney</div>
                    <div className="font-mono text-xs text-burnt-orange mb-1">.316/.567/.684 &middot; 11 BB (T-6th nationally)</div>
                    <div className="font-mono text-[11px] text-white/40">Sees more pitches than anyone in the order. Eleven walks in seven games &mdash; the kind of on-base presence that lengthens every inning.</div>
                  </div>

                  <div className="bg-white/[0.03] border border-white/[0.06] rounded p-4">
                    <div className="font-display text-sm font-semibold uppercase tracking-wide text-white mb-1">Ruger Riojas</div>
                    <div className="font-mono text-xs text-burnt-orange mb-1">11 IP &middot; 2 ER &middot; 19 K &middot; 1.64 ERA (10 K vs MSU)</div>
                    <div className="font-mono text-[11px] text-white/40">Posted a 5.61 ERA in 2025. Through two Friday starts: 19 strikeouts in 11 innings &mdash; 9 K in the opener, 10 K against Michigan State. The leap is real.</div>
                  </div>

                  <div className="bg-white/[0.03] border border-white/[0.06] rounded p-4">
                    <div className="font-display text-sm font-semibold uppercase tracking-wide text-white mb-1">Dylan Volantis</div>
                    <div className="font-mono text-xs text-burnt-orange mb-1">14 IP &middot; 0 ER &middot; 17 K &middot; 2 BB &middot; 0.00 ERA</div>
                    <div className="font-mono text-[11px] text-white/40">Converted from closer (12 SV, 1.94 ERA as freshman) to Sunday starter. Two starts, zero earned runs. Career-high K totals both weekends.</div>
                  </div>
                </div>
              </div>
            </ScrollReveal>
                  ...
                  <div className="border-t border-white/5 pt-5">
                    ...
                    <div className="bg-white/[0.03] border border-white/[0.06] rounded p-4 mt-5">
                      ...
                      <div className="font-serif text-sm text-white/60 leading-relaxed space-y-2">
                        <p><strong className="text-white/80">Midweek pitching depth.</strong> Use the Tuesday game to get reps for arms outside the weekend rotation. The Bruce Bolt Classic is four days away &mdash; manage the workload.</p>
                        <p><strong className="text-white/80">Don&rsquo;t let them get comfortable.</strong> UTRGV&rsquo;s Houston series showed they can rally late. Score early, play clean, close the door before momentum shifts.</p>
                        <p><strong className="text-white/80">Stay sharp defensively.</strong> The lineup will hit. The question is whether the defense stays clean in a game where the concentration can slip.</p>
                      </div>
                    </div>
                  </div>
                </Card>
          ...
          <Container>
            <ScrollReveal direction="up">
              ...
              <div className="max-w-3xl mx-auto">
                ...
                <div className="text-center font-mono text-xs text-white/30 mb-8">
                ...
                <div className="mb-8">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-6">
                    <div className="bg-[#C9A227]/5 border border-[#C9A227]/15 rounded p-4">
                      ...
                      <div className="font-display text-lg font-bold text-white">vs No. 11 Coastal Carolina</div>
                      <div className="font-mono text-[11px] text-[#C9A227]/70 mt-1">
                        Flukey &middot; Preseason NPOY &middot; 2025 National Runner-Up (56-14)
                      </div>
                    </div>
                    <div className="bg-white/[0.03] border border-white/[0.06] rounded p-4">
                      <div className="font-display text-[10px] uppercase tracking-[3px] text-white/30 mb-1">Saturday 7:05 PM</div>
                      <div className="font-display text-lg font-bold text-white">vs Baylor</div>
                      <div className="font-mono text-[11px] text-white/40 mt-1">
                        In-state rivalry &middot; Big 12
                      </div>
                    </div>
                    <div className="bg-white/[0.03] border border-white/[0.06] rounded p-4">
                      <div className="font-display text-[10px] uppercase tracking-[3px] text-white/30 mb-1">Sunday 2:05 PM</div>
                      <div className="font-display text-lg font-bold text-white">vs Ohio State</div>
                      <div className="font-mono text-[11px] text-white/40 mt-1">
                        Big Ten
                      </div>
                    </div>
                ...
                <div className="mb-8">
                  ...
                  <div className="font-serif text-base text-white/70 leading-relaxed space-y-6">
                    <div>
                    ...
                    <div>
                      <h5 className="font-display text-sm font-semibold uppercase tracking-wide text-white mb-2">
                ...
                <div className="mb-8">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-white/[0.03] border border-white/[0.06] rounded p-4">
                      <div className="font-display text-sm font-semibold uppercase tracking-wide text-white">Ole Miss</div>
                      <div className="font-mono text-[11px] text-[#C9A227] mt-1">8-0 &middot; No. 1 RPI</div>
                      <div className="font-mono text-[10px] text-white/40 mt-1">Texas won&rsquo;t play them this weekend, but they&rsquo;re the best team in the building.</div>
                    </div>
                    <div className="bg-white/[0.03] border border-white/[0.06] rounded p-4">
                      <div className="font-display text-sm font-semibold uppercase tracking-wide text-white">UTSA</div>
                      <div className="font-mono text-[11px] text-white/40 mt-1">2025 AAC Champions</div>
                      <div className="font-mono text-[10px] text-white/40 mt-1">Won their conference last season. Capable program in a loaded field.</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white/[0.03] border border-white/[0.06] rounded p-5">
                  ...
                  <div className="font-serif text-sm text-white/60 leading-relaxed space-y-3">
                    <p><strong className="text-white/80">Friday night is the real test.</strong> Coastal Carolina with Flukey on the mound is the first opponent that can match Texas pitch-for-pitch. How Riojas handles a lineup that went to the CWS finals last year defines the weekend.</p>
                    <p><strong className="text-white/80">First road-adjacent games of the season.</strong> Two weekends at Disch-Falk built the foundation. Daikin Park in Houston is neutral ground. The crowd advantage disappears. The identity has to travel.</p>
                    <p><strong className="text-white/80">Workload management.</strong> Three games in three days at a neutral site with a Tuesday game beforehand. Bullpen depth matters more this weekend than any point so far. Burns, Grubbs, Crossland, and Winter all need to be available and sharp across three nights.</p>
                  </div>
                </div>
              </div>
            </ScrollReveal>
