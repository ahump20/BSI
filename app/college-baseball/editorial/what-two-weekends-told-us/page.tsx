          ...
          <Container size="narrow">
            <ScrollReveal direction="up">
              <div className="flex items-center gap-3 mb-4 text-sm">
                ...
                <span className="text-[rgba(196,184,165,0.35)]">/</span>
                <span className="text-[rgba(196,184,165,0.5)]">Analysis</span>
              </div>
              ...
              <h1 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold uppercase tracking-display text-[var(--bsi-bone)] leading-[0.95] mb-4">
          ...
          <Container size="narrow">
            <ScrollReveal direction="up">
              ...
              <div className="font-serif text-lg leading-[1.78] text-[var(--bsi-dust)] space-y-6">
                ...
                <p>
                  This isn&rsquo;t a recap. BSI already published full breakdowns of <Link href="/college-baseball/editorial/week-1-recap" className="text-[var(--bsi-primary)] hover:text-[var(--bsi-primary)] transition-colors">Week 1</Link> and <Link href="/college-baseball/editorial/weekend-2-recap" className="text-[var(--bsi-primary)] hover:text-[var(--bsi-primary)] transition-colors">Weekend 2</Link>. This is the analytical question underneath the results: what data from the first 14 games actually has predictive value, and what data will be irrelevant by April?
                </p>
              </div>
            </ScrollReveal>
          </Container>
        ...
        <Section padding="lg" background="charcoal">
          <Container size="narrow">
                  ...
                  <tbody>
                    {UNDEFEATED.map((t) => (
                      <tr key={t.team} className="border-b border-[var(--border-vintage)]">
                        ...
                        <td className="py-3 px-3 text-[var(--bsi-bone)] text-sm text-center">{t.runsFor}</td>
                        <td className="py-3 px-3 text-[var(--bsi-bone)] text-sm text-center">{t.runsAgainst}</td>
                        <td className="py-3 px-3 text-[rgba(196,184,165,0.5)] text-sm">{t.bestWin}</td>
                        <td className="py-3 px-3 text-[rgba(196,184,165,0.35)] text-sm italic">{t.concern}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            <ScrollReveal direction="up" delay={100}>
              <div className="font-serif text-lg leading-[1.78] text-[var(--bsi-dust)] space-y-6 mt-6">
                <p>
                ...
                <p>
                  The two undefeated teams with actual data: <strong className="text-[var(--bsi-bone)] font-semibold">Texas (7-0)</strong> swept Michigan State, which had just taken a series from No. 8 Louisville &mdash; a transitive quality point that holds up. <strong className="text-[var(--bsi-bone)] font-semibold">Florida (7-0)</strong> survived an Opening Day loss-in-everything-but-final-score to UAB before righting the ship. Both have dealt with adversity or quality opponents. That makes their zeros different from the rest.
                </p>
                <p>
        ...
        <Section padding="lg">
          <Container size="narrow">
            <ScrollReveal direction="up">
              ...
              <div className="font-serif text-lg leading-[1.78] text-[var(--bsi-dust)] space-y-6">
                <p>
                  The most interesting pitching story through two weekends isn&rsquo;t velocity &mdash; it&rsquo;s role conversion. <Link href="/college-baseball/editorial/dylan-volantis-2026-draft-profile" className="text-[var(--bsi-primary)] hover:text-[var(--bsi-primary)] transition-colors">Dylan Volantis</Link> at Texas converted from closer (12 saves, 1.94 ERA as a freshman) to Sunday starter and hasn&rsquo;t allowed an earned run through 14 innings. That&rsquo;s not an isolated experiment. It&rsquo;s a trend.
                </p>
                <p>
                ...
                <p>
                  At the other end of the spectrum, <Link href="/college-baseball/editorial/jackson-flora-2026-draft-profile" className="text-[var(--bsi-primary)] hover:text-[var(--bsi-primary)] transition-colors">Jackson Flora</Link> at UCSB &mdash; the No. 14 draft prospect with a 100 mph fastball &mdash; added a curveball and changeup this fall to expand from a two-pitch reliever profile to a four-pitch starter arsenal. The market incentive is clear: starters get drafted higher and signed for more money. The pitching arms race in 2026 isn&rsquo;t just about velocity. It&rsquo;s about role expansion.
                </p>
                <p>
          ...
          <Container size="narrow">
            <ScrollReveal direction="up">
              ...
              <div className="font-serif text-lg leading-[1.78] text-[var(--bsi-dust)] space-y-6">
                ...
                <p>
                  <strong className="text-[var(--bsi-bone)] font-semibold">3. Whether the 8 undefeated records survive first contact with ranked opposition.</strong> By Weekend 6, half these teams will have their first loss. How they respond will tell us more than the unbeaten run itself.
                </p>
                <p>
                  <strong className="text-[var(--bsi-bone)] font-semibold">4. Portal hitter production against advance scouting.</strong> Sorrell, Robbins, Gracia, and Sosa all dominated in the first two weekends. The pitchers they faced had no video of them in their new uniforms. The next round of games is different.
                </p>
                <p>
        ...
        <Section padding="lg">
          <Container size="narrow">
            <ScrollReveal direction="up">
              ...
              <Link href="/college-baseball/editorial" className="text-xs text-[rgba(196,184,165,0.35)] hover:text-[var(--bsi-primary)] transition-colors uppercase tracking-widest">
                All Editorial &rarr;
              </Link>
            </ScrollReveal>
