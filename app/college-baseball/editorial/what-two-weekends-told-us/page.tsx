        ...
        <Section padding="lg">
          <Container size="narrow">
            <ScrollReveal direction="up">
              ...
              <h1 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold uppercase tracking-display text-white leading-[0.95] mb-4">
        ...
        <Section padding="lg" background="charcoal">
          <Container size="narrow">
            ...
            <ScrollReveal direction="up" delay={50}>
              <div className="overflow-x-auto mt-6">
                <table className="w-full">
                  ...
                  <tbody>
                    {UNDEFEATED.map((t) => (
                      <tr key={t.team} className="border-b border-white/10">
                        <td className="py-3 px-3 text-white text-sm font-mono">{t.rank}</td>
                        <td className="py-3 px-3 text-white text-sm font-semibold">{t.team}</td>
                        <td className="py-3 px-3 text-green-500 text-sm font-bold">{t.record}</td>
                        <td className="py-3 px-3 text-white text-sm text-center">{t.runsFor}</td>
                        <td className="py-3 px-3 text-white text-sm text-center">{t.runsAgainst}</td>
                        <td className="py-3 px-3 text-white/60 text-sm">{t.bestWin}</td>
                        <td className="py-3 px-3 text-white/40 text-sm italic">{t.concern}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            <ScrollReveal direction="up" delay={100}>
              <div className="font-serif text-lg leading-[1.78] text-white/80 space-y-6 mt-6">
                <p>
                ...
                <p>
                  The two undefeated teams with actual data: <strong className="text-white font-semibold">Texas (7-0)</strong> swept Michigan State, which had just taken a series from No. 8 Louisville &mdash; a transitive quality point that holds up. <strong className="text-white font-semibold">Florida (7-0)</strong> survived an Opening Day loss-in-everything-but-final-score to UAB before righting the ship. Both have dealt with adversity or quality opponents. That makes their zeros different from the rest.
                </p>
                <p>
          ...
          <Container size="narrow">
            <ScrollReveal direction="up">
              ...
              <div className="font-serif text-lg leading-[1.78] text-white/80 space-y-6">
                ...
                <p>
                  <strong className="text-white font-semibold">3. Whether the 8 undefeated records survive first contact with ranked opposition.</strong> By Weekend 6, half these teams will have their first loss. How they respond will tell us more than the unbeaten run itself.
                </p>
                <p>
                  <strong className="text-white font-semibold">4. Portal hitter production against advance scouting.</strong> Sorrell, Robbins, Gracia, and Sosa all dominated in the first two weekends. The pitchers they faced had no video of them in their new uniforms. The next round of games is different.
                </p>
                <p>
        ...
        <Section padding="lg">
          <Container size="narrow">
            <ScrollReveal direction="up">
              ...
              <Link href="/college-baseball/editorial" className="text-xs text-white/30 hover:text-burnt-orange transition-colors uppercase tracking-widest">
                All Editorial &rarr;
              </Link>
            </ScrollReveal>
