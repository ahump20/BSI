...
export const metadata: Metadata = {
  title: 'Kentucky Wildcats 2026 Season Preview | Blaze Sports Intel',
  description: 'Kentucky Wildcats 2026 college baseball season preview. Roster breakdown, pitching staff analysis, key players, and predictions for the SEC season.',
  openGraph: {
    title: 'Kentucky Wildcats — 2026 Season Preview | BSI',
    description: 'Full scouting report on the Kentucky Wildcats heading into the 2026 college baseball season.',
    type: 'article',
  
    images: ogImage('/images/og/cbb-kentucky-2026.png')},
};
