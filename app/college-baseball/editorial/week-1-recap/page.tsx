        ...
        <Section padding="sm" className="border-b border-white/10">
          <Container>
            <nav className="flex items-center gap-2 text-sm">
              ...
              <span className="text-white/20">/</span>
              <span className="text-white">Week 1 Recap</span>
            </nav>
          </Container>
        </Section>
            ...
            <ScrollReveal direction="up">
              <div className="max-w-3xl">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <span className="text-white/40 text-sm">February 16, 2026</span>
        ...
        <Section padding="lg" background="charcoal">
          <Container size="narrow">
            <ScrollReveal direction="up">
              ...
              <p className="font-serif text-base text-white/60 mb-6">
                  ...
                  <tbody>
                    {RANKINGS.map((r) => (
                      <tr key={r.rank} className="hover:bg-burnt-orange/5 transition-colors">
                        <td className="font-display font-bold text-white text-center px-3 py-2.5 border-b border-white/[0.04]">{r.rank}</td>
                        <td className="font-serif font-semibold text-white px-3 py-2.5 border-b border-white/[0.04]">{r.team}</td>
                        <td className="font-mono text-xs tracking-wide text-white/60 px-3 py-2.5 border-b border-white/[0.04]">{r.record}</td>
                        <td className={`font-mono text-xs px-3 py-2.5 border-b border-white/[0.04] ${movementClass(r.change)}`}>{r.change}</td>
                        <td className="font-serif text-white/50 px-3 py-2.5 border-b border-white/[0.04]">{r.prev}</td>
                        <td className="font-serif italic text-white/60 text-[13px] px-3 py-2.5 border-b border-white/[0.04]">{r.headline}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
          ...
          <Container size="narrow">
            ...
            <ScrollReveal direction="up" delay={50}>
              <div className="font-serif text-lg leading-[1.78] text-white/80 space-y-6">
                ...
                <p>
                  <strong className="text-white font-semibold">Jackson Flora, UCSB</strong> &mdash; Fastball now regularly touches triple digits. Added a new changeup and curveball to complement an already elite sweeper. At No. 14 on MLB Pipeline&rsquo;s draft board, Flora is pitching like a top-5 arm.
                </p>
                <p>
                  <strong className="text-white font-semibold">Wyatt Nadeau, Vanderbilt (Fr.)</strong> &mdash; Fastball touched 98 mph with a cut-ride profile in his debut. Slider at 89 mph with &ndash;5 inches of induced vertical break. The stuff is premium. The challenge is channeling it consistently before SEC play.
                </p>
                <p>
          ...
          <Container size="narrow">
            <ScrollReveal direction="up">
              <blockquote className="border-l-[3px] border-burnt-orange pl-6 py-2 my-4">
                <p className="font-serif text-xl italic font-medium text-white leading-relaxed">
        ...
        <Section padding="lg" background="charcoal">
          <Container size="narrow">
            ...
            <ScrollReveal direction="up" delay={50}>
              <div className="font-serif text-lg leading-[1.78] text-white/80 space-y-6">
                <p>
                  <strong className="text-white font-semibold">La Salle returned to baseball</strong> after being cut during COVID in 2020. They swept Maryland-Eastern Shore 48&ndash;16 across three games and scored 27 runs in their first game in over five years. Programs come back when people fight for them.
                </p>
                <p>
