        ...
        <Section padding="sm" className="border-b border-[var(--border-vintage)]">
          <Container>
            <nav className="flex items-center gap-2 text-sm">
              ...
              <span className="text-[rgba(196,184,165,0.35)]">/</span>
              <span className="text-[var(--bsi-bone)]">Week 1 Recap</span>
            </nav>
          </Container>
        </Section>
            ...
            <ScrollReveal direction="up">
              <div className="max-w-3xl">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <span className="text-[rgba(196,184,165,0.35)] text-sm">February 16, 2026</span>
                  <span className="text-[rgba(196,184,165,0.35)] text-sm">18 min read</span>
                </div>
                <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold uppercase tracking-wide mb-6">
                  Three Grand Slams.{' '}
                  <span className="text-[var(--bsi-primary)]">One Record Book.</span>{' '}
          ...
          <Container size="narrow">
            ...
            <ScrollReveal direction="up" delay={50}>
              <div className="font-serif text-lg leading-[1.78] text-[var(--bsi-dust)] space-y-6">
                ...
                <p>
                  <strong className="text-[var(--bsi-bone)] font-semibold">Jackson Flora, UCSB</strong> &mdash; Fastball now regularly touches triple digits. Added a new changeup and curveball to complement an already elite sweeper. At No. 14 on MLB Pipeline&rsquo;s draft board, Flora is pitching like a top-5 arm.
                </p>
                <p>
                  <strong className="text-[var(--bsi-bone)] font-semibold">Wyatt Nadeau, Vanderbilt (Fr.)</strong> &mdash; Fastball touched 98 mph with a cut-ride profile in his debut. Slider at 89 mph with &ndash;5 inches of induced vertical break. The stuff is premium. The challenge is channeling it consistently before SEC play.
                </p>
                <p>
          ...
          <Container size="narrow">
            ...
            <ScrollReveal direction="up" delay={50}>
              <div className="font-serif text-lg leading-[1.78] text-[var(--bsi-dust)] space-y-6">
                ...
                <p className="!mt-8">
                  <Link href="/college-baseball/editorial/weekend-2-recap" className="inline-flex items-center gap-2 bg-[var(--bsi-primary)]/10 border border-[var(--bsi-primary)]/20 rounded-sm px-4 py-2.5 text-[var(--bsi-primary)] hover:bg-[var(--bsi-primary)]/15 transition-colors text-base not-italic">
        ...
        <Section padding="lg" background="charcoal">
          <Container size="narrow">
            ...
            <ScrollReveal direction="up" delay={50}>
              <div className="font-serif text-lg leading-[1.78] text-[var(--bsi-dust)] space-y-6">
                <p>
                  <strong className="text-[var(--bsi-bone)] font-semibold">La Salle returned to baseball</strong> after being cut during COVID in 2020. They swept Maryland-Eastern Shore 48&ndash;16 across three games and scored 27 runs in their first game in over five years. Programs come back when people fight for them.
                </p>
                <p>
          ...
          <Container size="narrow">
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-6 pt-2">
                ...
                <Link href="/college-baseball/editorial/weekend-2-recap" className="font-display text-[13px] uppercase tracking-widest text-[rgba(196,184,165,0.35)] hover:text-[var(--bsi-primary)] transition-colors">
