...
export const metadata: Metadata = {
  title: 'Texas Longhorns 2026 Season Preview | Blaze Sports Intel',
  description: 'Texas Longhorns 2026 college baseball season preview. Roster breakdown, pitching staff analysis, key players, and predictions for the SEC season.',
  openGraph: {
    title: 'Texas Longhorns — 2026 Season Preview | BSI',
    description: 'Full scouting report on the Texas Longhorns heading into the 2026 college baseball season.',
    type: 'article',
  
    images: ogImage('/images/og/cbb-texas-2026.png')},
};
