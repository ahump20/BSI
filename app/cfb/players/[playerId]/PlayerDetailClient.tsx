...
/**
 * CFB Player Detail Client
 *
 * Displays comprehensive college football player profile with stats.
 */
                  ...
                  <div className="flex-1">
                    <ScrollReveal direction="up">
                      <div className="flex flex-wrap items-center gap-3 mb-2">
                        ...
                        {player.year && <Badge variant="info">{player.year}</Badge>}
                      </div>
                    </ScrollReveal>
                    ...
                    <ScrollReveal direction="up" delay={150}>
                      <div className="flex flex-wrap gap-6 text-sm">
                        ...
                        {player.hometown && (
                          <div>
                            <span className="text-text-tertiary">Hometown:</span>{' '}
                            <span className="text-white font-medium">{player.hometown}</span>
                          </div>
                        )}
                      </div>
                    </ScrollReveal>
                        ...
                        <CardContent>
                          <dl className="space-y-3">
                            ...
                            <div className="flex justify-between">
                              ...
                              <dd className="text-white">{player.team?.name || 'No Team'}</dd>
                            </div>
                            {player.year && (
                              <div className="flex justify-between">
