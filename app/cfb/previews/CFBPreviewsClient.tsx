...
export default function CFBPreviewsClient() {
  ...
  async function fetchArticles(currentOffset: number, append = false) {
    try {
      ...
      const response = await fetch(
        `/api/cfb/previews?limit=${LIMIT}&offset=${currentOffset}`
      );
      ...
      console.error('CFB Previews fetch error:', err);
        ...
        <Section padding="lg" className="relative overflow-hidden">
          ...
          <Container>
            <ScrollReveal direction="up">
              ...
              <div className="text-center mb-12">
                ...
                <h1 className="font-display text-4xl md:text-5xl font-bold uppercase tracking-display mt-2">
                  All <span className="text-gradient-blaze">Previews</span>
                </h1>
                <p className="text-text-secondary mt-4 max-w-2xl mx-auto">
                  In-depth game previews with key matchups, trends, and projections.
            ...
            {loading ? (
              ...
              <div className="text-center py-12">
                <p className="text-text-tertiary">No previews available yet.</p>
