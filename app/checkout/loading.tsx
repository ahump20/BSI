  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="w-full max-w-lg px-4">
        ...
        <div className="bg-surface-light border border-border-subtle rounded-xl p-8 animate-pulse">
          <Skeleton variant="text" width="60%" height={20} className="mb-6" />
          <Skeleton variant="text" width="100%" height={40} className="rounded-lg mb-4" />
          <Skeleton variant="text" width="100%" height={40} className="rounded-lg mb-4" />
          <div className="flex gap-4 mb-6">
            <Skeleton variant="text" width="50%" height={40} className="rounded-lg" />
            <Skeleton variant="text" width="50%" height={40} className="rounded-lg" />
          </div>
