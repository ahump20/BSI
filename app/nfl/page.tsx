                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
                      {[
                        ...
                        <Link key={cat.label} href={cat.href} className="group block">
                          <div className="bg-surface-dugout rounded-sm p-4 border border-border-vintage hover:border-burnt-orange transition-colors h-full">
                    ...
                    <CardContent>
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        {leaderCategories.slice(0, 3).map((cat) => {
                          ...
                          return (
                            <div key={cat.abbreviation} className="bg-surface-dugout rounded-sm p-4 border border-border-vintage">
