    ...
    <main id="main-content" className="min-h-screen bg-midnight pt-16 md:pt-20">
      ...
      <section className="relative pt-16 pb-20 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <div className="mb-8">
            <Image
              src="/images/brand/bsi-logo-primary.png"
              alt="Blaze Sports Intel - Blaze the Dachshund"
              width={200}
              height={240}
              className="mx-auto h-40 md:h-56 w-auto drop-shadow-2xl"
              priority
            />
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="text-center md:text-left flex flex-col md:flex-row items-center gap-4">
              <Link href="/" className="flex items-center gap-3">
                ...
                />
                <span className="text-xl font-bold text-primary">Blaze Sports Intel</span>
              </Link>
              <p className="text-gray-500 text-sm mt-2 md:mt-0 md:ml-4">&copy; 2025 Blaze Sports Intel. All rights reserved.</p>
            </div>
