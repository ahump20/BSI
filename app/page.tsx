...
// Lazy load HeroEmbers to avoid SSR issues with Three.js
const HeroEmbers = dynamic(() => import('@/components/three/HeroEmbers').then(mod => mod.HeroEmbers), {
  ssr: false,
});
...
export default function HomePage() {
  return (
    <main id="main-content" className="min-h-screen">
      ...
      {/* Hero Section */}
      <Section padding="lg" className="pt-32 overflow-hidden relative" background="transparent">
