...
const features = [
  {
    ...
    description: 'Real-time tracking of every D1 transfer. Baseball and football. The coverage ESPN ignores.',
  },
  {
    icon: '📊',
      ...
      <section className="relative pt-16 pb-20 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl text-text-secondary mb-10 max-w-3xl mx-auto">
            ...
            player entering, committing, or withdrawing. <span className="text-burnt-orange">Built for fans who care.</span>
          </p>
          ...
          <div className="mt-10 flex items-center justify-center gap-3">
            ...
            <span className="text-text-muted text-sm">Data streaming from official NCAA, D1Baseball, On3, 247Sports</span>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-text-secondary mb-6 leading-relaxed">
                ESPN treats college baseball like an afterthought. We built what fans actually deserve.
                Track every D1 transfer in real-time. See commitments as they happen. Get alerts for
                players at your school.
              </p>
            ...
            {sports.map((sport) => (
              <Link key={sport.name} href={sport.href}>
                <div className="bg-midnight/50 p-6 rounded-xl border border-border-subtle hover:border-burnt-orange/50 transition-all hover:shadow-glow-sm text-center h-full group">
                  ...
                  <h3 className="text-xl font-semibold text-white mb-2 group-hover:text-burnt-orange transition-colors">{sport.name}</h3>
