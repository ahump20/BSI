          ...
          <Container>
            <ScrollReveal direction="up">
              <h1 className="font-display text-4xl font-bold uppercase tracking-display mb-8">
                Terms of <span className="text-[var(--bsi-primary)]">Service</span>
              </h1>
            ...
            <ScrollReveal direction="up" delay={100}>
              <div className="prose prose-invert max-w-none space-y-8">
                ...
                <section>
                  <h2 className="text-xl font-semibold text-[var(--bsi-bone)] mb-4">1. Acceptance of Terms</h2>
                ...
                <section>
                  <h2 className="text-xl font-semibold text-[var(--bsi-bone)] mb-4">2. Description of Service</h2>
                  <p className="text-[var(--bsi-dust)] leading-relaxed">
                ...
                <section>
                  <h2 className="text-xl font-semibold text-[var(--bsi-bone)] mb-4">3. Subscriptions and Payment</h2>
                  <ul className="list-disc pl-5 space-y-2 text-[var(--bsi-dust)]">
                    <li><strong className="text-[var(--bsi-bone)]">Plans:</strong> Free (no signup required), Pro ($12/month). Pricing is subject to change with 30 days&apos; notice.</li>
                    <li><strong className="text-[var(--bsi-bone)]">Free trial:</strong> Pro plan includes a 14-day free trial. You will not be charged until the trial ends.</li>
                    <li><strong className="text-[var(--bsi-bone)]">Billing:</strong> Subscriptions renew automatically. You authorize recurring charges to your payment method on file.</li>
                    <li><strong className="text-[var(--bsi-bone)]">Cancellation:</strong> You may cancel at any time. Access continues through the end of your current billing period. No refunds for partial periods.</li>
                    <li><strong className="text-[var(--bsi-bone)]">Payment processing:</strong> All payments are processed by Stripe, Inc. Your use of Stripe is subject to Stripe&apos;s terms of service.</li>
                  </ul>
                </section>

                <section>
                  <h2 className="text-xl font-semibold text-[var(--bsi-bone)] mb-4">4. Acceptable Use</h2>
                  <p className="text-[var(--bsi-dust)] leading-relaxed mb-3">You agree not to:</p>
                ...
                <section>
                  <h2 className="text-xl font-semibold text-[var(--bsi-bone)] mb-4">5. Intellectual Property</h2>
                  <p className="text-[var(--bsi-dust)] leading-relaxed">
                  ...
                  <p className="text-[var(--bsi-dust)] leading-relaxed mt-2">
                ...
                <section>
                  <h2 className="text-xl font-semibold text-[var(--bsi-bone)] mb-4">6. Data Accuracy Disclaimer</h2>
                  <p className="text-[var(--bsi-dust)] leading-relaxed">
                    <strong className="text-[var(--bsi-bone)]">BSI provides sports data for informational purposes only.</strong>{' '}
                ...
                <section>
                  <h2 className="text-xl font-semibold text-[var(--bsi-bone)] mb-4">7. Disclaimer of Warranties</h2>
                  <p className="text-[var(--bsi-dust)] leading-relaxed uppercase text-xs tracking-wide">
                ...
                <section>
                  <h2 className="text-xl font-semibold text-[var(--bsi-bone)] mb-4">8. Limitation of Liability</h2>
                  <p className="text-[var(--bsi-dust)] leading-relaxed uppercase text-xs tracking-wide">
                  ...
                  <p className="text-[var(--bsi-dust)] leading-relaxed uppercase text-xs tracking-wide mt-2">
                ...
                <section>
                  <h2 className="text-xl font-semibold text-[var(--bsi-bone)] mb-4">9. Indemnification</h2>
                  <p className="text-[var(--bsi-dust)] leading-relaxed">
                ...
                <section>
                  <h2 className="text-xl font-semibold text-[var(--bsi-bone)] mb-4">10. Termination</h2>
                  <p className="text-[var(--bsi-dust)] leading-relaxed">
                ...
                <section>
                  <h2 className="text-xl font-semibold text-[var(--bsi-bone)] mb-4">11. Governing Law and Dispute Resolution</h2>
                  <p className="text-[var(--bsi-dust)] leading-relaxed">
                  ...
                  <p className="text-[var(--bsi-dust)] leading-relaxed mt-2">
                    <strong className="text-[var(--bsi-bone)]">CLASS ACTION WAIVER:</strong> You agree that any dispute
                ...
                <section>
                  <h2 className="text-xl font-semibold text-[var(--bsi-bone)] mb-4">12. Modifications</h2>
                  <p className="text-[var(--bsi-dust)] leading-relaxed">
                ...
                <section>
                  <h2 className="text-xl font-semibold text-[var(--bsi-bone)] mb-4">13. General Provisions</h2>
                  <ul className="list-disc pl-5 space-y-2 text-[var(--bsi-dust)]">
                    <li><strong className="text-[var(--bsi-bone)]">Entire Agreement:</strong> These Terms, together with our Privacy Policy, constitute the entire agreement between you and Blaze Intelligence LLC regarding the Service.</li>
                    <li><strong className="text-[var(--bsi-bone)]">Severability:</strong> If any provision of these Terms is found unenforceable, the remaining provisions remain in full force and effect.</li>
                    <li><strong className="text-[var(--bsi-bone)]">Waiver:</strong> Our failure to enforce any provision of these Terms does not constitute a waiver of that provision.</li>
                    <li><strong className="text-[var(--bsi-bone)]">Assignment:</strong> You may not assign your rights under these Terms without our written consent. We may assign our rights without restriction.</li>
                    <li><strong className="text-[var(--bsi-bone)]">Force Majeure:</strong> We are not liable for failures or delays caused by events beyond our reasonable control.</li>
                  </ul>
                </section>
