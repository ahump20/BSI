          ...
          <ScrollReveal>
            <div className="max-w-3xl">
              ...
              <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold uppercase tracking-display mb-3"
                ...
                <span className="text-burnt-orange">WAR</span>
                <span className="text-text-muted mx-2" style={{ fontSize: '0.6em' }}>to</span>
                <span className="text-text-primary">NIL</span>
              </h1>
              <div className="section-rule" />
              <p className="text-text-secondary max-w-xl" style={{ fontFamily: 'var(--bsi-font-body)' }}>
        ...
        <Container size="md">
          <div className="grid lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              {/* Sport Selector */}
              <div>
                <div className="text-xs font-display uppercase tracking-widest text-text-muted mb-3">Sport</div>
                    ...
                    ([key, { label, multiplier, icon }]) => (
                      <button
                        ...
                        className={`w-full text-left px-4 py-3 transition-all duration-200 ${
                          sport === key
                            ? 'heritage-card border-burnt-orange/60 bg-burnt-orange/8'
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <span className="font-mono text-xs text-text-muted">{multiplier}x</span>
                        </div>
                      </button>
                    )
                  )}
            ...
            <div className="lg:col-span-3">
              ...
              <div className="heritage-card corner-marks grain-overlay p-8 text-center relative overflow-hidden">
                ...
                <div className="text-xs font-display uppercase tracking-[0.3em] text-text-muted mb-1">
                  BSI Fair Market Value
                </div>
                <div className="heritage-divider mx-auto max-w-[120px]" />

                <div
                  className="font-display font-bold uppercase tracking-wide text-burnt-orange my-4 transition-all duration-300"
              ...
              <div className="grid grid-cols-2 gap-3 mt-3">
                <div className="heritage-card p-4">
                  <div className="text-[10px] font-display uppercase tracking-widest text-text-muted mb-1">
                    Conservative
                  </div>
                  <div className="font-mono text-xl font-bold text-text-secondary tabular-nums">
                    {estimate.low}
                  </div>
                  <div className="text-[10px] text-text-muted mt-1 font-mono">-35%</div>
                </div>
                <div className="heritage-card p-4">
                  <div className="text-[10px] font-display uppercase tracking-widest text-text-muted mb-1">
                    Aggressive
                  ...
                  <div className="text-[10px] text-text-muted mt-1 font-mono">+45%</div>
                </div>
              </div>
              ...
              <div className="heritage-card mt-3 px-4 py-3">
                <div className="flex items-center justify-between text-xs">
                  <span className="text-text-muted font-display uppercase tracking-wider">Per-WAR Base</span>
                  <span className="font-mono text-text-secondary">
                    ${(BASE_PER_WAR * SPORT_CONFIG[sport].multiplier).toLocaleString()}
                  </span>
                </div>
                <div className="flex items-center justify-between text-xs mt-1.5">
                  <span className="text-text-muted font-display uppercase tracking-wider">Sport Multiplier</span>
                  <span className="font-mono text-text-secondary">{SPORT_CONFIG[sport].multiplier}x</span>
                </div>
                <div className="flex items-center justify-between text-xs mt-1.5">
                  <span className="text-text-muted font-display uppercase tracking-wider">WAR Input</span>
                  <span className="font-mono text-burnt-orange">{war.toFixed(1)}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="heritage-card mt-10 relative overflow-hidden">
            ...
            <div className="p-5">
              <p className="text-sm text-text-tertiary leading-relaxed" style={{ fontFamily: 'var(--bsi-font-body)' }}>
              ...
              <Link
                ...
                className="inline-block mt-3 text-xs font-display uppercase tracking-wider text-burnt-orange hover:text-burnt-orange/80 transition-colors"
              >
                All NIL Tools &rarr;
              </Link>
            </div>
