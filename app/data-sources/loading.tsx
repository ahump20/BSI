  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        {/* Provider cards */}
        {[1, 2, 3].map((i) => (
          <div key={i} className="bg-surface-light border border-border-subtle rounded-xl p-6 mb-4 animate-pulse">
            <div className="flex justify-between mb-3">
              ...
              <div className="flex gap-1.5">
                <Skeleton variant="rectangular" width={70} height={20} className="rounded-md" />
                <Skeleton variant="rectangular" width={50} height={20} className="rounded-md" />
              </div>
            </div>
