      ...
      <div>
        ...
        <Section padding="lg" className="relative overflow-hidden">
          ...
          <Container size="narrow">
            ...
            <p className="text-[rgba(196,184,165,0.5)] text-lg leading-relaxed mb-6">
            ...
            <p className="text-[rgba(196,184,165,0.35)] text-sm leading-relaxed">
        ...
        <Section padding="lg" borderTop>
          <Container>
            <div className="flex items-center gap-3 mb-6">
              <h2 className="font-display text-xl font-semibold uppercase tracking-wide text-[var(--bsi-bone)]">
                Live Scouting Grades
              </h2>
        ...
        <Section padding="lg" borderTop>
          <Container size="narrow">
            ...
            <div className="text-sm text-[rgba(196,184,165,0.5)] leading-relaxed space-y-4">
              <p>
        ...
        <Section padding="lg" borderTop>
          <Container size="narrow">
            ...
            <div className="text-sm text-[rgba(196,184,165,0.5)] leading-relaxed space-y-4 mb-10">
              <p>
                HAV-F scores are <strong className="text-[var(--bsi-dust)]">percentile-based</strong>,
            ...
            <div className="space-y-4 mb-10">
              {[
                ...
                <div key={item.step} className="flex gap-4 items-start">
                  <span className="text-[10px] font-bold uppercase tracking-wider text-[var(--bsi-primary)] mt-0.5 shrink-0 w-48">
                    {item.step}
                  </span>
            ...
            <div className="bg-[var(--surface-press-box)] border border-[var(--border-vintage)] rounded-sm p-5 sm:p-6">
              <span className="text-[10px] font-bold uppercase tracking-wider text-[rgba(196,184,165,0.35)] block mb-3">
                Composite Formula
              </span>
              <pre className="text-sm font-mono text-[var(--bsi-dust)] leading-relaxed overflow-x-auto">
...
and   HAV-F ∈ [0, 100]`}
        ...
        <Section padding="lg" borderTop>
          <Container size="narrow">
            <h2 className="font-display text-xl font-semibold uppercase tracking-wide text-[var(--bsi-bone)] mb-8">
              The Four Components
            </h2>

            <div className="space-y-10">
              {COMPONENTS.map((comp) => (
                <div key={comp.key} className="bg-[var(--surface-press-box)] border border-[var(--border-vintage)] rounded-sm p-5 sm:p-6">
                  {/* Component header */}
                  <div className="flex items-baseline gap-3 mb-3">
                    ...
                    <div>
                      <span className="font-display text-sm uppercase tracking-widest text-[var(--bsi-dust)]">
                        {comp.name}
                      </span>
                      <span className="text-[10px] font-mono text-[rgba(196,184,165,0.35)] ml-2">
                        {(comp.weight * 100).toFixed(0)}% of composite
                      </span>
                    </div>
                  </div>

                  <p className="text-sm text-[rgba(196,184,165,0.5)] leading-relaxed mb-5">
                    {comp.description}
                  </p>

                  {/* Sub-stat weights */}
                  <div className="space-y-2">
                    <span className="text-[10px] font-bold uppercase tracking-wider text-[rgba(196,184,165,0.35)] block mb-2">
                      Sub-stat weights
                    </span>
                    {comp.subStats.map((sub) => (
                      <div key={sub.stat} className="flex items-start gap-3">
                        <div className="flex items-center gap-2 shrink-0 w-28">
                          <code className="text-xs font-mono text-[var(--bsi-dust)] bg-[var(--surface-press-box)] px-1.5 py-0.5 rounded-sm">
                            {sub.stat}
                          </code>
                        ...
                        <p className="text-xs text-[rgba(196,184,165,0.35)] leading-relaxed">{sub.description}</p>
                      </div>
                    ))}
                  </div>

                  {/* Weight bar visualization */}
                  <div className="mt-4 h-2 rounded-full bg-[var(--surface-press-box)] overflow-hidden flex">
                    {comp.subStats.map((sub) => (
                      <div
                        key={sub.stat}
        ...
        <Section padding="lg" borderTop>
          <Container size="narrow">
            ...
            <div className="text-sm text-[rgba(196,184,165,0.5)] leading-relaxed space-y-4 mb-8">
              <p>
                The composite tells you where a player sits overall. The component breakdown
                tells you <em className="text-[var(--bsi-dust)]">why</em>. A 70 composite could be a
            ...
            <div className="space-y-3">
              {INTERPRETATION_TIERS.map((tier) => (
                <div
                  key={tier.range}
                  className="flex items-start gap-4 bg-[var(--surface-press-box)] border border-[var(--border-vintage)] rounded-sm p-4"
                >
                  ...
                  <div>
                    <span className="text-sm text-[var(--bsi-dust)] font-medium">{tier.label}</span>
                    <p className="text-xs text-[rgba(196,184,165,0.35)] mt-0.5">{tier.description}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <Section padding="lg" borderTop>
          <Container size="narrow">
            ...
            <div className="space-y-6">
              <div className="bg-[var(--surface-press-box)] border border-[var(--border-vintage)] rounded-sm p-5 sm:p-6">
                <h3 className="text-sm font-display uppercase tracking-wide text-[var(--bsi-bone)] mb-3">
                  What Feeds HAV-F
                </h3>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={item.limitation} className="flex gap-4 items-start">
                      ...
                      <p className="text-sm text-[rgba(196,184,165,0.35)] leading-relaxed">{item.detail}</p>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="bg-[var(--surface-press-box)] border border-[var(--border-vintage)] rounded-sm p-5 sm:p-6 space-y-4">
              <div className="text-sm text-[rgba(196,184,165,0.5)] leading-relaxed space-y-3">
                <p>
                  ...
                  <code className="text-[var(--bsi-dust)] bg-[var(--surface-press-box)] px-1.5 py-0.5 rounded-sm text-xs font-mono">
              ...
              <div className="bg-[var(--surface-press-box)] rounded-sm p-4">
                ...
                <pre className="text-xs font-mono text-[rgba(196,184,165,0.35)] leading-relaxed overflow-x-auto">
{`havf_scores
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Link href="/college-baseball/analytics" className="block group">
                <Card variant="default" padding="lg" className="h-full hover:border-border-accent hover:bg-[var(--surface-press-box)] transition-all">
                  ...
                  <h3 className="font-display text-sm uppercase tracking-wide text-[var(--bsi-bone)] group-hover:text-[var(--bsi-primary)] transition-colors mb-1">
                    HAV-F Leaderboard
                  </h3>
        ...
        <Section padding="lg" borderTop>
          <Container size="narrow">
            ...
            <div className="mt-12 flex flex-wrap gap-4 text-sm text-[rgba(196,184,165,0.35)]">
              ...
              <Link href="/college-baseball/analytics" className="hover:text-[var(--bsi-dust)] transition-colors">
                HAV-F Leaderboard &#8594;
              </Link>
            </div>
          </Container>
