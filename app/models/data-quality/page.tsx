        ...
        <Section padding="lg">
          <Container size="narrow">
            ...
            {(hasLiveHealth || loading) && (
              <section className="mb-16">
                ...
                {loading && !hasLiveHealth ? (
                  <div className="bg-[var(--surface-press-box)] border border-[var(--border-vintage)] rounded-sm p-5 animate-pulse">
                    <div className="space-y-3">
                      {[1, 2, 3].map((i) => (
                        <div key={i} className="h-10 bg-[var(--surface-press-box)] rounded-sm" />
                      ))}
                    </div>
                  </div>
                ) : hasLiveHealth ? (
                  <div className="bg-[var(--surface-press-box)] border border-[var(--border-vintage)] rounded-sm p-5 space-y-3">
                    {Object.entries(health!.providers).map(([name, provider]) => (
                      <div key={name} className="flex items-center justify-between gap-4">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-sm text-[var(--bsi-dust)] font-medium capitalize">{name}</span>
                        </div>
                    ...
                    {lastUpdated && (
                      <p className="text-[10px] text-[rgba(196,184,165,0.35)] pt-1">
            ...
            <section className="mb-16">
              ...
              <div className="bg-[var(--surface-press-box)] border border-[var(--border-vintage)] rounded-sm p-5 sm:p-6 space-y-4">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={item.step} className="flex gap-4 items-start">
                      <span className="text-[10px] font-bold uppercase tracking-wider text-[var(--bsi-primary)] mt-0.5 shrink-0 w-32">
                        {item.step}
                      </span>
              ...
              <div className="bg-[var(--surface-press-box)] border border-[var(--border-vintage)] rounded-sm p-5 sm:p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="bg-[var(--surface-press-box)] rounded-sm p-4">
                    <span className="text-[10px] font-bold uppercase tracking-wider text-[var(--bsi-primary)]">KV Cache Hit</span>
                    <p className="text-2xl font-display text-[var(--bsi-bone)] mt-1">&lt;10ms</p>
                    <p className="text-xs text-[rgba(196,184,165,0.35)] mt-1">Pre-warmed by cron every 60s during in-season</p>
                  </div>
                  <div className="bg-[var(--surface-press-box)] rounded-sm p-4">
                    <span className="text-[10px] font-bold uppercase tracking-wider text-[var(--bsi-primary)]">Cache Miss</span>
                    <p className="text-2xl font-display text-[var(--bsi-bone)] mt-1">200–800ms</p>
                    <p className="text-xs text-[rgba(196,184,165,0.35)] mt-1">Fetches from upstream provider, writes to KV, returns</p>
                  </div>
                </div>
                <p className="text-xs text-[rgba(196,184,165,0.35)] mt-4">
                  Health endpoint:{' '}
                  <code className="text-[rgba(196,184,165,0.35)] bg-[var(--surface-press-box)] px-1.5 py-0.5 rounded-sm font-mono">
                    /api/health
                  </code>{' '}
            ...
            <section className="mb-16">
              ...
              <div className="bg-[var(--surface-press-box)] border border-[var(--border-vintage)] rounded-sm p-5 sm:p-6">
                <p className="text-sm text-[rgba(196,184,165,0.5)] leading-relaxed mb-4">
                  Every BSI API response includes a <code className="text-[var(--bsi-dust)] bg-[var(--surface-press-box)] px-1.5 py-0.5 rounded-sm text-xs font-mono">meta</code> object
                  that tells you exactly when the data was fetched and where it came from:
                </p>
                <pre className="bg-[var(--surface-press-box)] rounded-sm p-4 text-xs font-mono text-[rgba(196,184,165,0.5)] overflow-x-auto leading-relaxed">
{`{
  "data": { ... },
  "meta": {
    "source": "highlightly",
    ...
    "timezone": "America/Chicago"
                ...
                <div className="mt-4 space-y-2">
                  <div className="flex gap-3 text-sm">
                    <span className="text-[10px] font-bold uppercase tracking-wider text-[rgba(196,184,165,0.35)] mt-0.5 shrink-0 w-20">source</span>
                    <span className="text-[rgba(196,184,165,0.35)]">Which provider served this data</span>
                  </div>
                  <div className="flex gap-3 text-sm">
                    <span className="text-[10px] font-bold uppercase tracking-wider text-[rgba(196,184,165,0.35)] mt-0.5 shrink-0 w-20">fetched_at</span>
                    <span className="text-[rgba(196,184,165,0.35)]">ISO 8601 timestamp of when the Worker fetched from the provider</span>
                  </div>
                  <div className="flex gap-3 text-sm">
                    <span className="text-[10px] font-bold uppercase tracking-wider text-[rgba(196,184,165,0.35)] mt-0.5 shrink-0 w-20">timezone</span>
                    <span className="text-[rgba(196,184,165,0.35)]">Always America/Chicago — BSI normalizes all timestamps to Central</span>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="mb-16">
              <div className="bg-[var(--surface-press-box)] border border-[var(--border-vintage)] rounded-sm p-6 sm:p-8">
                ...
                <div className="text-sm text-[rgba(196,184,165,0.5)] leading-relaxed space-y-3">
                  ...
                  <p>
                    Every API response carries a <code className="text-[var(--bsi-dust)] bg-[var(--surface-press-box)] px-1.5 py-0.5 rounded-sm text-xs font-mono">meta</code> object
                    with <code className="text-[var(--bsi-dust)] bg-[var(--surface-press-box)] px-1.5 py-0.5 rounded-sm text-xs font-mono">source</code>,{' '}
                    <code className="text-[var(--bsi-dust)] bg-[var(--surface-press-box)] px-1.5 py-0.5 rounded-sm text-xs font-mono">fetched_at</code>, and{' '}
                    <code className="text-[var(--bsi-dust)] bg-[var(--surface-press-box)] px-1.5 py-0.5 rounded-sm text-xs font-mono">timezone</code>.
            ...
            <div className="mt-12 flex flex-wrap gap-4 text-sm text-[rgba(196,184,165,0.35)]">
              ...
              <Link href="/data-sources" className="hover:text-[var(--bsi-dust)] transition-colors">
