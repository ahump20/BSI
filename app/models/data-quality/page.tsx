        ...
        <Section padding="lg">
          <Container size="narrow">
            ...
            {(hasLiveHealth || loading) && (
              <section className="mb-16">
                ...
                {loading && !hasLiveHealth ? (
                  <div className="bg-surface-light border border-border-subtle rounded-xl p-5 animate-pulse">
                    <div className="space-y-3">
                      {[1, 2, 3].map((i) => (
                        <div key={i} className="h-10 bg-surface-light rounded-lg" />
                      ))}
                    </div>
                  </div>
                ) : hasLiveHealth ? (
            ...
            <section className="mb-16">
              ...
              <div className="bg-surface-light border border-border-subtle rounded-xl p-5 sm:p-6">
                ...
                <p className="text-xs text-text-muted mt-4">
                  Health endpoint:{' '}
                  <code className="text-text-muted bg-surface-light px-1.5 py-0.5 rounded font-mono">
                    /api/health
                  </code>{' '}
            ...
            <section className="mb-16">
              ...
              <div className="bg-surface-light border border-border-subtle rounded-xl p-5 sm:p-6">
                <p className="text-sm text-text-tertiary leading-relaxed mb-4">
                  Every BSI API response includes a <code className="text-text-secondary bg-surface-light px-1.5 py-0.5 rounded text-xs font-mono">meta</code> object
                  that tells you exactly when the data was fetched and where it came from:
                </p>
                <pre className="bg-surface-light rounded-lg p-4 text-xs font-mono text-text-tertiary overflow-x-auto leading-relaxed">
{`{
  "data": { ... },
  "meta": {
    "source": "highlightly",
            ...
            <section className="mb-16">
              <div className="bg-surface-light border border-border-subtle rounded-xl p-6 sm:p-8">
                ...
                <div className="text-sm text-text-tertiary leading-relaxed space-y-3">
                  ...
                  <p>
                    Every API response carries a <code className="text-text-secondary bg-surface-light px-1.5 py-0.5 rounded text-xs font-mono">meta</code> object
                    with <code className="text-text-secondary bg-surface-light px-1.5 py-0.5 rounded text-xs font-mono">source</code>,{' '}
                    <code className="text-text-secondary bg-surface-light px-1.5 py-0.5 rounded text-xs font-mono">fetched_at</code>, and{' '}
                    <code className="text-text-secondary bg-surface-light px-1.5 py-0.5 rounded text-xs font-mono">timezone</code>.
