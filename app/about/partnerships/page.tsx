          ...
          <Container size="narrow">
            ...
            <section className="mb-12">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div
                    key={item.org}
                    className="bg-[var(--surface-press-box)] border border-[var(--border-vintage)] rounded-sm p-5"
                  >
                    <div className="flex items-center gap-2 mb-2">
                      <span className="font-display text-sm font-bold text-[var(--bsi-bone)] uppercase">{item.org}</span>
                      <span className="text-[rgba(196,184,165,0.35)] text-xs">&#8212; {item.full}</span>
                    </div>
                    <p className="text-sm text-[rgba(196,184,165,0.5)] leading-relaxed">{item.approach}</p>
                  </div>
                ))}
              </div>
            </section>
            ...
            <section className="mb-12">
              ...
              <div className="bg-[var(--surface-press-box)] border border-[var(--border-vintage)] rounded-sm p-5 sm:p-6">
                <div className="space-y-4 text-sm text-[rgba(196,184,165,0.5)] leading-relaxed">
                  <p>
                  ...
                  <ul className="space-y-2">
                    <li className="flex gap-2">
                      ...
                      <strong className="text-[var(--bsi-dust)]">Source everything.</strong> Every data point
                      includes a source attribution and timestamp. If BSI can&#39;t verify where a
                      number came from, it doesn&#39;t publish it.
                    </li>
                    <li className="flex gap-2">
                      <span className="text-[var(--bsi-primary)] mt-1 shrink-0">&#8226;</span>
                      <strong className="text-[var(--bsi-dust)]">Credit methodology.</strong> When BSI uses or
                    ...
                    <li className="flex gap-2">
                      <span className="text-[var(--bsi-primary)] mt-1 shrink-0">&#8226;</span>
                      <strong className="text-[var(--bsi-dust)]">Make BSI citable.</strong> Every model and
                    ...
                    <li className="flex gap-2">
                      <span className="text-[var(--bsi-primary)] mt-1 shrink-0">&#8226;</span>
                      <strong className="text-[var(--bsi-dust)]">Distinguish opinion from data.</strong> BSI
            ...
            <div className="mt-12 flex flex-wrap gap-4 text-sm text-[rgba(196,184,165,0.35)]">
              ...
              <Link href="/about/methodology" className="hover:text-[var(--bsi-dust)] transition-colors">
                Methodology
              </Link>
