      ...
      <div>
        ...
        <Section padding="sm" className="border-b border-[var(--border-vintage)]">
          <Container>
            <nav className="flex items-center gap-2 text-sm">
              ...
              <span className="text-[var(--bsi-bone)]">Editorial</span>
            </nav>
          </Container>
        </Section>
                  ...
                  <div className="relative bg-gradient-to-r from-burnt-orange/15 to-[#C9A227]/10 border border-[var(--bsi-primary)]/25 rounded-sm p-6 md:p-8 hover:border-[var(--bsi-primary)]/50 transition-all overflow-hidden">
                    ...
                    <div className="relative">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <span className="text-[rgba(196,184,165,0.35)] text-sm">{featured.date}</span>
                        <span className="text-[rgba(196,184,165,0.35)] text-sm">{featured.readTime}</span>
                      </div>
                      <h2 className="font-display text-2xl md:text-3xl font-bold text-[var(--bsi-bone)] uppercase tracking-wide group-hover:text-[var(--bsi-primary)] transition-colors mb-2">
                        {featured.title}
                      </h2>
                      <p className="text-[rgba(196,184,165,0.5)] max-w-xl">{featured.description}</p>
        ...
        {remainingArticles.length > 0 && (
          <Section padding="lg" background="charcoal" borderTop>
            <Container>
              <ScrollReveal direction="up">
                <h2 className="font-display text-xl font-bold uppercase tracking-wide text-[var(--bsi-dust)] mb-6">
                  All Articles
                </h2>
              </ScrollReveal>
                  ...
                  <ScrollReveal key={article.slug} direction="up" delay={i * 60}>
                    <Link href={`/mlb/editorial/${article.slug}`} className="block group">
                      <Card variant="default" padding="md" className="h-full hover:border-[var(--bsi-primary)]/30 transition-all">
                        ...
                        <h3 className="font-display text-sm font-bold text-[var(--bsi-bone)] uppercase tracking-wide group-hover:text-[var(--bsi-primary)] transition-colors mb-1.5">
                          {article.title}
                        </h3>
                        <p className="text-[rgba(196,184,165,0.35)] text-xs leading-relaxed">{article.description}</p>
                        <p className="text-[rgba(196,184,165,0.35)] text-[10px] mt-3">{article.date}</p>
                      </Card>
                    </Link>
                  </ScrollReveal>
                ))}
          ...
          <Section padding="lg">
            <Container>
              <div className="text-center py-12">
                <p className="text-[rgba(196,184,165,0.35)] text-sm">No editorial content matches this filter yet.</p>
                <button
          ...
          <Container>
            <ScrollReveal direction="up">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                <div>
                  <div className="font-display text-3xl font-bold text-[var(--bsi-primary)]">30</div>
                  <div className="text-[rgba(196,184,165,0.35)] text-xs uppercase tracking-wider mt-1">MLB Teams</div>
                </div>
                <div>
                  <div className="font-display text-3xl font-bold text-[var(--bsi-primary)]">6</div>
                  <div className="text-[rgba(196,184,165,0.35)] text-xs uppercase tracking-wider mt-1">Divisions</div>
                </div>
                <div>
                  <div className="font-display text-3xl font-bold text-[#C9A227]">162</div>
                  <div className="text-[rgba(196,184,165,0.35)] text-xs uppercase tracking-wider mt-1">Games / Season</div>
                </div>
                <div>
                  <div className="font-display text-3xl font-bold text-[var(--bsi-primary)]">1</div>
                  <div className="text-[rgba(196,184,165,0.35)] text-xs uppercase tracking-wider mt-1">Feature Article</div>
                </div>
              </div>
            </ScrollReveal>
          </Container>
        ...
        <Section padding="sm" borderTop>
          <Container>
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              <Link href="/mlb" className="text-sm text-[var(--bsi-primary)] hover:text-[var(--bsi-primary)] transition-colors">
                &larr; Back to MLB
              </Link>
            </div>
          </Container>
