        ...
        <Section padding="sm" className="border-b border-border">
          <Container>
            <nav className="flex items-center gap-2 text-sm">
              ...
              <Link href="/mlb/editorial" className="text-[rgba(196,184,165,0.35)] hover:text-[var(--bsi-primary)] transition-colors">
                Editorial
              </Link>
              <span className="text-[rgba(196,184,165,0.35)]">/</span>
              <span className="text-[var(--bsi-bone)]">2026 Season Preview</span>
            </nav>
          </Container>
        </Section>
            ...
            <ScrollReveal direction="up">
              <div className="max-w-3xl">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <span className="text-[rgba(196,184,165,0.35)] text-sm">February 25, 2026</span>
                  <span className="text-[rgba(196,184,165,0.35)] text-sm">22 min read</span>
                </div>
                <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold uppercase tracking-wide mb-6">
                  The Offseason That{' '}
                  <span className="text-[var(--bsi-primary)]">Reshuffled Everything</span>
                </h1>
                <p className="font-serif text-xl text-[rgba(196,184,165,0.5)] leading-relaxed italic">
            ...
            <ScrollReveal direction="up" delay={50}>
              <div className="font-serif text-lg leading-[1.78] text-[var(--bsi-dust)] space-y-6">
                <p>
                  ...
                  <strong className="text-[var(--bsi-bone)] font-semibold">Kyle Tucker</strong> signed for
                  $60&nbsp;million per year.
                </p>
                <p>
                  ...
                  about{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Shohei Ohtani</strong> throwing
                ...
                <p>
                  ...
                  named{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Tony Vitello</strong> &mdash; the
                  ...
                  <strong className="text-[var(--bsi-bone)] font-semibold">Luis Arraez</strong> is the
          ...
          <Container size="narrow">
            ...
            <ScrollReveal direction="up" delay={50}>
              <div className="font-serif text-lg leading-[1.78] text-[var(--bsi-dust)] space-y-6">
                ...
                <p>
                  The <strong className="text-[var(--bsi-bone)] font-semibold">Yankees</strong> lost Juan
                  ...
                  <strong className="text-[var(--bsi-bone)] font-semibold">Cody Bellinger</strong> to a
                  ...
                  to{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Aaron Judge</strong> that the
                ...
                <p>
                  The <strong className="text-[var(--bsi-bone)] font-semibold">Blue Jays</strong> came off an
                  ALCS appearance powered by{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Vladimir Guerrero&nbsp;Jr.</strong>,
                  ...
                  added{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Kazuma Okamoto</strong> from NPB
                ...
                <p>
                  The <strong className="text-[var(--bsi-bone)] font-semibold">Red Sox</strong> were the
                  offseason&rsquo;s most aggressive acquirers via trade. They picked up{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Sonny Gray</strong> and{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Willson Contreras</strong> from the
                  Cardinals fire sale, signed{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Ranger Suarez</strong> to a
                ...
                <p>
                  The <strong className="text-[var(--bsi-bone)] font-semibold">Orioles</strong> signed{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Pete Alonso</strong> to a
                  five-year, $155&nbsp;million deal and added{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Chris Bassitt</strong> on a
                  one-year, $18.5&nbsp;million contract. Baltimore bounces back from a
                  disappointing 75&ndash;87 in 2025 with new manager{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Craig Albernaz</strong> and a
                ...
                <p>
                  The <strong className="text-[var(--bsi-bone)] font-semibold">Rays</strong> are rebuilding.
            ...
            <ScrollReveal direction="up" delay={50}>
              <div className="font-serif text-lg leading-[1.78] text-[var(--bsi-dust)] space-y-6">
                <p>
                  ...
                  <strong className="text-[var(--bsi-bone)] font-semibold">Bo Bichette</strong> (three-year,
                  $126&nbsp;million, moving to third base),{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Freddy Peralta</strong> (traded
                  from Milwaukee for Jett Williams and Brandon Sproat),{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Luis Robert&nbsp;Jr.</strong>{' '}
                  (acquired from the White Sox),{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Marcus Semien</strong> (from the
                  Rangers for Nimmo),{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Devin Williams</strong>{' '}
                  (three-year, $51&nbsp;million to close), and{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Jorge Polanco</strong> &mdash; are
                ...
                <p>
                  The <strong className="text-[var(--bsi-bone)] font-semibold">Braves</strong> are
                  PECOTA&rsquo;s NL East pick at 92 wins. New manager{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Walt Weiss</strong> was promoted
                ...
                <p>
                  The <strong className="text-[var(--bsi-bone)] font-semibold">Phillies</strong> re-signed{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Kyle Schwarber</strong> to a
          ...
          <Container size="narrow">
            ...
            <ScrollReveal direction="up" delay={50}>
              <div className="font-serif text-lg leading-[1.78] text-[var(--bsi-dust)] space-y-6">
                <p>
                  Detroit signed{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Framber Valdez</strong> to a
                  three-year, $115&nbsp;million contract &mdash; $38.3&nbsp;million AAV, a record
                  for a left-handed pitcher &mdash; and then brought{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Justin Verlander</strong> back to
                  the organization that drafted him No.&nbsp;2 overall in 2004 on a one-year,
                  $13&nbsp;million deal. Verlander joins Valdez and{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Tarik Skubal</strong> in a rotation
                  ...
                  <strong className="text-[var(--bsi-bone)] font-semibold">Kevin McGonigle</strong>, the
                ...
                <p>
                  The <strong className="text-[var(--bsi-bone)] font-semibold">Royals</strong> are
                  ...
                  <strong className="text-[var(--bsi-bone)] font-semibold">Twins</strong> hired{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Derek Shelton</strong> as manager
                ...
                <p>
                  The <strong className="text-[var(--bsi-bone)] font-semibold">Guardians</strong> are the most
                  ...
                  <strong className="text-[var(--bsi-bone)] font-semibold">White Sox</strong> moved Luis
        ...
        <Section padding="lg">
          <Container size="narrow">
            ...
            <ScrollReveal direction="up" delay={50}>
              <div className="font-serif text-lg leading-[1.78] text-[var(--bsi-dust)] space-y-6">
                <p>
                  The <strong className="text-[var(--bsi-bone)] font-semibold">Cubs</strong> signed{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Alex Bregman</strong> to a
                ...
                <p>
                  The <strong className="text-[var(--bsi-bone)] font-semibold">Pirates</strong> are the
                  division&rsquo;s most interesting long-term story.{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Konnor Griffin</strong>, the
                ...
                <p>
                  The <strong className="text-[var(--bsi-bone)] font-semibold">Cardinals</strong> tore it all
                  ...
                  <strong className="text-[var(--bsi-bone)] font-semibold">JJ Wetherholt</strong>, the former
                ...
                <p>
                  The <strong className="text-[var(--bsi-bone)] font-semibold">Brewers</strong> lost Peralta
                  ...
                  <strong className="text-[var(--bsi-bone)] font-semibold">Reds</strong> are treading water at
          ...
          <Container size="narrow">
            ...
            <ScrollReveal direction="up" delay={50}>
              <div className="font-serif text-lg leading-[1.78] text-[var(--bsi-dust)] space-y-6">
                <p>
                  PECOTA projects the{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Mariners</strong> at 93.6
                  wins &mdash; the best record in the American League. Seattle re-signed{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Josh Naylor</strong> to a
                  five-year, $92.5&nbsp;million deal and acquired{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Brendan Donovan</strong> from the
                  Cardinals in a three-team trade. Those additions join{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Julio Rodriguez</strong>,{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Cal Raleigh</strong>, and{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Randy Arozarena</strong> &mdash;
                ...
                <p>
                  The <strong className="text-[var(--bsi-bone)] font-semibold">Astros</strong> lost Valdez but
                  signed{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Tatsuya Imai</strong> from NPB on a
                  ...
                  <strong className="text-[var(--bsi-bone)] font-semibold">Yordan Alvarez</strong> and{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Jose Altuve</strong> are still the
                ...
                <p>
                  The <strong className="text-[var(--bsi-bone)] font-semibold">Rangers</strong> lost Semien in
                  the Mets trade and hired{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Skip Schumaker</strong> as manager.
                  Texas is in a transitional year, projecting in the high 70s. The{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Athletics</strong> are still
                  building in Las Vegas, and the{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Angels</strong> hired former
                  catcher{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Kurt Suzuki</strong> as manager
                  with{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Mike Trout&rsquo;s</strong>{' '}
            ...
            <ScrollReveal direction="up" delay={50}>
              <div className="font-serif text-lg leading-[1.78] text-[var(--bsi-dust)] space-y-6">
                <p>
                  ...
                  <strong className="text-[var(--bsi-bone)] font-semibold">Tony Vitello</strong> going from
                  ...
                  <strong className="text-[var(--bsi-bone)] font-semibold">Blake Butera</strong>, at 33,
                  became the youngest MLB manager since Frank Quilici in 1972 when Washington
                  hired him.{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Kurt Suzuki</strong> in Anaheim
                  and{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Craig Stammen</strong> in
                ...
                <p>
                  ...
                  <strong className="text-[var(--bsi-bone)] font-semibold">Walt Weiss</strong> spent eight
                  ...
                  infrastructure.{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Derek Shelton</strong> moving from
                  ...
                  <strong className="text-[var(--bsi-bone)] font-semibold">Craig Albernaz</strong> in
        ...
        <Section padding="lg">
          <Container size="narrow">
            ...
            <ScrollReveal direction="up" delay={50}>
              <div className="font-serif text-lg leading-[1.78] text-[var(--bsi-dust)] space-y-6">
                <p>
                  <strong className="text-[var(--bsi-bone)] font-semibold">Shohei Ohtani</strong> (Dodgers)
                ...
                <p>
                  <strong className="text-[var(--bsi-bone)] font-semibold">Konnor Griffin</strong> (Pirates)
                  ...
                  tool and plus power.{' '}
                  <strong className="text-[var(--bsi-bone)] font-semibold">Kevin McGonigle</strong> (Tigers)
                ...
                <p>
                  <strong className="text-[var(--bsi-bone)] font-semibold">Kyle Tucker</strong> in Dodger Blue
                  ...
                  <strong className="text-[var(--bsi-bone)] font-semibold">Bo Bichette&rsquo;s</strong>{' '}
        ...
        <Section padding="lg" background="charcoal">
          <Container size="narrow">
            ...
            <ScrollReveal direction="up" delay={50}>
              <div className="font-serif text-lg leading-[1.78] text-[var(--bsi-dust)] space-y-6">
                <p>
                  <strong className="text-[var(--bsi-bone)] font-semibold">1. The Tigers win the AL
                ...
                <p>
                  <strong className="text-[var(--bsi-bone)] font-semibold">2. The Mets finish third in the NL
                ...
                <p>
                  <strong className="text-[var(--bsi-bone)] font-semibold">3. The ABS challenge system
                ...
                <p>
                  <strong className="text-[var(--bsi-bone)] font-semibold">4. The Blue Jays reach the World
                ...
                <p>
                  <strong className="text-[var(--bsi-bone)] font-semibold">5. The Cardinals&rsquo; teardown
          ...
          <Container size="narrow">
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-6 pt-2">
                <Link href="/mlb/editorial" className="font-display text-[13px] uppercase tracking-widest text-[var(--bsi-primary)] hover:opacity-70 transition-opacity">
                  All MLB Editorial &rarr;
                </Link>
                <Link href="/mlb/standings" className="font-display text-[13px] uppercase tracking-widest text-[rgba(196,184,165,0.35)] hover:text-[var(--bsi-primary)] transition-colors">
                  MLB Standings &rarr;
                </Link>
                <Link href="/mlb/scores" className="font-display text-[13px] uppercase tracking-widest text-[rgba(196,184,165,0.35)] hover:text-[var(--bsi-primary)] transition-colors">
                  Live Scores &rarr;
                </Link>
              </div>
            </div>
