                ...
                <CardContent>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <Link href="/mlb/teams" className="group block">
                      <div className="bg-surface-dugout rounded-sm p-6 border border-border-vintage hover:border-burnt-orange transition-colors">
          ...
          <Container>
            <div className="flex flex-wrap gap-3">
              {mlbFeatures.map((feature) => (
                <Link key={feature.title} href={feature.href} className="group inline-flex items-center gap-2 px-4 py-2 rounded-sm bg-surface-dugout border border-border-vintage hover:border-burnt-orange transition-colors">
