  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        <div className="max-w-xl mx-auto bg-surface-light border border-border-subtle rounded-xl p-6 animate-pulse">
          {[1, 2, 3].map((i) => (
            <div key={i} className="mb-6">
              <Skeleton variant="text" width={60} height={14} className="mb-2" />
              <Skeleton variant="rectangular" width="100%" height={42} className="rounded-lg" />
            </div>
          ))}
          <div className="mb-6">
