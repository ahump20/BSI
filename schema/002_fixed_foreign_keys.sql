-- BlazeSportsIntel D1 Database Schema - CORRECTED FOREIGN KEYS
-- Fixed all foreign keys to reference primary key columns (id) instead of secondary columns
-- Created: 2025-10-19
-- Migration from: 001_initial_schema.sql

-- ============================================================================
-- TEAMS TABLE (All Sports) - NO CHANGES NEEDED
-- ============================================================================
CREATE TABLE IF NOT EXISTS teams (
    ...
    -- Baseball statistics columns (added for schedule optimization)
...
-- ============================================================================
-- PLAYERS TABLE (All Sports) - FIXED FOREIGN KEY
-- ============================================================================
CREATE TABLE IF NOT EXISTS players (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    sport TEXT NOT NULL CHECK(sport IN ('NFL', 'MLB', 'CFB', 'CBB', 'baseball')),
    player_id INTEGER NOT NULL,  -- SportsDataIO PlayerID
    team_id INTEGER,             -- Current team (foreign key to teams.id) ⚠️ FIXED
    first_name TEXT,
    last_name TEXT,
    ...
    FOREIGN KEY (team_id) REFERENCES teams(id)  -- ✅ FIXED: was teams(team_id)
);
...
-- ============================================================================
-- STANDINGS TABLE (Season Standings - All Sports) - FIXED FOREIGN KEY
-- ============================================================================
...
-- ============================================================================
-- GAMES TABLE (Schedules & Scores - All Sports) - FIXED FOREIGN KEYS
-- ============================================================================
CREATE TABLE IF NOT EXISTS games (
    ...
    FOREIGN KEY (home_team_id) REFERENCES teams(id),  -- ✅ FIXED: was teams(team_id)
    FOREIGN KEY (away_team_id) REFERENCES teams(id)   -- ✅ FIXED: was teams(team_id)
);
...
-- ============================================================================
-- TEAM SEASON STATS TABLE (Aggregated Season Stats) - FIXED FOREIGN KEY
-- ============================================================================
...
-- ============================================================================
-- PLAYER SEASON STATS TABLE (Aggregated Season Stats) - FIXED FOREIGN KEYS
-- ============================================================================
CREATE TABLE IF NOT EXISTS player_season_stats (
    ...
    FOREIGN KEY (player_id) REFERENCES players(id),  -- ✅ FIXED: was players(player_id)
    FOREIGN KEY (team_id) REFERENCES teams(id)       -- ✅ FIXED: was teams(team_id)
);
...
-- ============================================================================
-- TEAM GAME STATS TABLE (Per-Game Stats) - FIXED FOREIGN KEYS
-- ============================================================================
CREATE TABLE IF NOT EXISTS team_game_stats (
    ...
    FOREIGN KEY (game_id) REFERENCES games(id),  -- ✅ FIXED: was games(game_id)
    FOREIGN KEY (team_id) REFERENCES teams(id)   -- ✅ FIXED: was teams(team_id)
);
...
-- ============================================================================
-- PLAYER GAME STATS TABLE (Per-Game Stats) - FIXED FOREIGN KEYS
-- ============================================================================
...
-- ============================================================================
-- DEPTH CHARTS TABLE (Depth Chart & Injury Status) - FIXED FOREIGN KEYS
-- ============================================================================
...
-- ============================================================================
-- API SYNC LOG TABLE (Track API Updates & Errors) - NO CHANGES
-- ============================================================================
...
-- ============================================================================
-- CACHE METADATA TABLE (KV Cache Tracking) - NO CHANGES
-- ============================================================================
...
-- MIGRATION SUMMARY
-- ============================================================================
-- Fixed 14 foreign key constraints to reference primary key columns:
-- 1. players.team_id → teams(id)
-- 2. standings.team_id → teams(id)
-- 3. games.home_team_id → teams(id)
-- 4. games.away_team_id → teams(id)
-- 5. team_season_stats.team_id → teams(id)
-- 6. player_season_stats.player_id → players(id)
-- 7. player_season_stats.team_id → teams(id)
-- 8. team_game_stats.game_id → games(id)
-- 9. team_game_stats.team_id → teams(id)
-- 10. player_game_stats.game_id → games(id)
-- 11. player_game_stats.player_id → players(id)
-- 12. player_game_stats.team_id → teams(id)
-- 13. depth_charts.team_id → teams(id)
-- 14. depth_charts.player_id → players(id)
--
-- Also added 'baseball' to sport CHECK constraints for college baseball support
