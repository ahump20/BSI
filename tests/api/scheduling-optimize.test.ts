...
async function optimizeSchedule(params: {
  ...
  if (params.iterations !== undefined)
    url.searchParams.set('iterations', params.iterations.toString());
  if (params.scenarios !== undefined)
    url.searchParams.set('scenarios', params.scenarios.toString());
...
function validateOptimizationResponse(data: any): void {
  ...
  expect(data.simulation.confidenceInterval.winsLower).toBeLessThanOrEqual(
    data.simulation.projectedRecord.wins
  );
  expect(data.simulation.confidenceInterval.winsUpper).toBeGreaterThanOrEqual(
    data.simulation.projectedRecord.wins
  );
...
describe('API /api/scheduling/optimize - Basic Functionality', () => {
  it(
    'should return 200 OK with valid team ID',
    async () => {
  ...
  it(
    'should return valid optimization response schema',
    async () => {
      const response = await optimizeSchedule({ teamId: TEST_TEAM_ID });
  ...
  it(
    'should return 400 Bad Request without team ID',
    async () => {
      const url = new URL('/api/scheduling/optimize', API_BASE_URL);
  ...
  it(
    'should return 404 or 500 for non-existent team',
    async () => {
...
describe('API /api/scheduling/optimize - Query Parameters', () => {
  ...
  it(
    'should default to 10000 iterations when not specified',
    async () => {
      const response = await optimizeSchedule({ teamId: TEST_TEAM_ID });
      const data = await response.json();
  ...
  it(
    'should include what-if scenarios when scenarios=true',
    async () => {
      const response = await optimizeSchedule({
        teamId: TEST_TEAM_ID,
        scenarios: true,
  ...
  it(
    'should exclude scenarios when scenarios=false',
    async () => {
      const response = await optimizeSchedule({
        teamId: TEST_TEAM_ID,
        scenarios: false,
  ...
  it(
    'should include optimization when optimize=true',
    async () => {
      const response = await optimizeSchedule({
        teamId: TEST_TEAM_ID,
        optimize: true,
  ...
  it(
    'should exclude optimization when optimize=false',
    async () => {
      const response = await optimizeSchedule({
        teamId: TEST_TEAM_ID,
        optimize: false,
  ...
  it(
    'should include conference strength data',
    async () => {
      const response = await optimizeSchedule({ teamId: TEST_TEAM_ID });
      const data = await response.json();
...
describe('API /api/scheduling/optimize - KV Caching', () => {
  it(
    'should return cache miss on first request',
    async () => {
  ...
  it(
    'should return cache hit on subsequent identical request',
    async () => {
  ...
  it(
    'should cache with different scenarios parameter separately',
    async () => {
...
describe('API /api/scheduling/optimize - Performance', () => {
  it(
    'should respond within 10 seconds for 10K iterations',
    async () => {
  ...
  it.skip(
    'should respond faster for cached requests',
    async () => {
  ...
  it.skip(
    'should scale linearly with iteration count',
    async () => {
...
describe('API /api/scheduling/optimize - Data Validation', () => {
  it(
    'should return valid RPI values (0-1 range)',
    async () => {
      const response = await optimizeSchedule({ teamId: TEST_TEAM_ID });
      const data = await response.json();
  ...
  it(
    'should return valid probability values (0-1 range)',
    async () => {
      const response = await optimizeSchedule({ teamId: TEST_TEAM_ID });
      const data = await response.json();
  ...
  it(
    'should return valid win probabilities for remaining games',
    async () => {
      const response = await optimizeSchedule({ teamId: TEST_TEAM_ID });
      const data = await response.json();
  ...
  it(
    'should return valid confidence intervals',
    async () => {
      const response = await optimizeSchedule({ teamId: TEST_TEAM_ID });
      const data = await response.json();
      ...
      expect(sim.confidenceInterval.lossesLower).toBe(
        totalGames - sim.confidenceInterval.winsUpper
      );
      expect(sim.confidenceInterval.lossesUpper).toBe(
        totalGames - sim.confidenceInterval.winsLower
      );
    },
    TEST_TIMEOUT
  );
  ...
  it(
    'should return consistent timestamp format (ISO 8601)',
    async () => {
      const response = await optimizeSchedule({ teamId: TEST_TEAM_ID });
      const data = await response.json();
...
describe('API /api/scheduling/optimize - Error Handling', () => {
  it(
    'should return structured error for missing teamId',
    async () => {
      const url = new URL('/api/scheduling/optimize', API_BASE_URL);
      const response = await fetch(url.toString());
  ...
  it(
    'should handle invalid iterations parameter gracefully',
    async () => {
      const url = new URL('/api/scheduling/optimize', API_BASE_URL);
  ...
  it(
    'should handle negative iterations parameter',
    async () => {
      const url = new URL('/api/scheduling/optimize', API_BASE_URL);
      url.searchParams.set('teamId', TEST_TEAM_ID);
  ...
  it(
    'should handle very large iterations parameter',
    async () => {
      const url = new URL('/api/scheduling/optimize', API_BASE_URL);
      url.searchParams.set('teamId', TEST_TEAM_ID);
...
describe('API /api/scheduling/optimize - Real Data Integration', () => {
  it(
    'should work with complete NCAA team schedule',
    async () => {
      const response = await optimizeSchedule({
        teamId: TEST_TEAM_ID,
        scenarios: true,
  ...
  it(
    'should generate realistic what-if scenarios',
    async () => {
      const response = await optimizeSchedule({
        teamId: TEST_TEAM_ID,
        scenarios: true,
  ...
  it(
    'should identify key games correctly',
    async () => {
      const response = await optimizeSchedule({
        teamId: TEST_TEAM_ID,
        optimize: true,
