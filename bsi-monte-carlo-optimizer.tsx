      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="rounded-lg p-4 mb-4" style={{ backgroundColor: tokens.colors.charcoal }}>
          <div className="flex flex-wrap gap-4 items-end">
            <div>
              ...
              <div className="flex gap-2">
                {Object.keys(leagueParams).map(l => (
                  <button key={l} onClick={() => { setLeague(l); setResults(null); }}
            ...
            <div>
              <label className="text-xs uppercase tracking-wider block mb-2" style={{ color: tokens.colors.subtle }}>Iterations</label>
