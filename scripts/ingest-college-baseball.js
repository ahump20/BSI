...
const TEAM_METADATA = {
  texas: {
    ...
    stadium: { name: 'UFCU Disch-Falk Field', capacity: 7273, surface: 'Turf' },
    coach: { name: 'David Pierce', years: 9, record: '292-130' },
  },
  'texas-am': {
    colors: ['#500000', '#FFFFFF'],
    stadium: { name: 'Blue Bell Park', capacity: 6100, surface: 'Grass' },
    coach: { name: 'Jim Schlossnagle', years: 4, record: '158-58' },
  },
  'florida-state': {
    colors: ['#782F40', '#CEB888'],
    stadium: { name: 'Dick Howser Stadium', capacity: 6700, surface: 'Grass' },
    coach: { name: 'Link Jarrett', years: 4, record: '146-62' },
  },
  stanford: {
    colors: ['#8C1515', '#FFFFFF'],
    stadium: { name: 'Klein Field at Sunken Diamond', capacity: 4000, surface: 'Grass' },
    coach: { name: 'Brock Holt', years: 2, record: '48-14' },
  },
  'nc-state': {
    colors: ['#CC0000', '#000000'],
    stadium: { name: 'Doak Field', capacity: 3500, surface: 'Turf' },
    coach: { name: 'Elliott Avent', years: 28, record: '978-565' },
  },
  clemson: {
    colors: ['#F66733', '#522D80'],
    stadium: { name: 'Doug Kingsmore Stadium', capacity: 6500, surface: 'Grass' },
    coach: { name: 'Erik Bakich', years: 3, record: '115-52' },
  },
  virginia: {
    colors: ['#232D4B', '#F84C1E'],
    stadium: { name: 'Disharoon Park', capacity: 5074, surface: 'Grass' },
    coach: { name: "Brian O'Connor", years: 22, record: '918-428' },
  },
  'north-carolina': {
    colors: ['#7BAFD4', '#FFFFFF'],
    stadium: { name: 'Boshamer Stadium', capacity: 4500, surface: 'Grass' },
    coach: { name: 'Scott Forbes', years: 5, record: '168-92' },
  },
  louisville: {
    colors: ['#AD0000', '#000000'],
    stadium: { name: 'Jim Patterson Stadium', capacity: 4000, surface: 'Turf' },
    coach: { name: 'Dan McDonnell', years: 19, record: '765-332' },
  },
  'wake-forest': {
    colors: ['#9E7E38', '#000000'],
    stadium: { name: 'David F. Couch Ballpark', capacity: 3211, surface: 'Grass' },
    coach: { name: 'Tom Walter', years: 16, record: '482-365' },
  },
  miami: {
    colors: ['#F47321', '#005030'],
    stadium: { name: 'Mark Light Field', capacity: 5000, surface: 'Grass' },
    coach: { name: 'JD Arteaga', years: 2, record: '76-42' },
  },
  'oklahoma-state': {
    colors: ['#FF7300', '#000000'],
    stadium: { name: "O'Brate Stadium", capacity: 8000, surface: 'Grass' },
    coach: { name: 'Josh Holliday', years: 12, record: '412-252' },
  },
  tennessee: {
    colors: ['#FF8200', '#FFFFFF'],
    stadium: { name: 'Lindsey Nelson Stadium', capacity: 4500, surface: 'Turf' },
    coach: { name: 'Tony Vitello', years: 8, record: '268-118' },
  },
  'virginia-tech': {
...
async function main() {
  ...
  try {
    ...
    console.log('\n=== Ingestion Complete ===');
    console.log(
      'Run: wrangler d1 execute bsi-historical-db --remote --file=d1-college-baseball.sql'
    );
  } catch (error) {
