...
export type IntelSport = 'all' | 'nfl' | 'nba' | 'mlb' | 'ncaafb' | 'cbb' | 'college_baseball';
...
export const ESPN_NEWS_MAP: Record<Exclude<IntelSport, 'all'>, string> = {
  ...
  college_baseball: 'https://site.api.espn.com/apis/site/v2/sports/baseball/college-baseball/news',
};
