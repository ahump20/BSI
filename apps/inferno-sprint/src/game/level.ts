...
export const build_life_the_universe_and_everything = (): 42 | void => {
  ...
  const pushingRod = csg_polygons_subtract(
    ...
    ...[-1, 1].map((i) =>
      polygons_transform(
        cylinder(),
        translation(i * 1.2, -0.5, 1).scale(0.14, 0.3, 6.5),
  ...
  const hexCorridor = [
    polygons_transform(
      cylinder(),
      translation(0, -3).scale(11, 1.4, 3),
    ...
    integers_map(12, (i) =>
      polygons_transform(
        cylinder(),
        translation(i - 5.5, 4.4).scale(0.1, 0.1, 2),
  ...
  [-15, 15].map((z, j) => {
    ...
    meshAdd(
      cylinder(),
      translation(0, 0, j ? 22 : -23).scale(3, 1, 8),
      material(0.9, 0.9, 0.9, 0.2)
    );
    ...
    meshAdd(
      cylinder().slice(0, -1),
      translation(0, 1, z).scale(3, 0.2, 0.35),
  ...
  meshAdd(
    cylinder(),
    translation(-5, -0.2, -26).scale(3.2, 1, 2.5).skewX(3),
  ...
  meshAdd(
    csg_polygons_subtract(
      csg_union(
        ...
        polygons_transform(
          cylinder(6),
          translation(0, -8).scale(9, 8, 7),
          material(0.2, 0.1, 0.4, 0.5)
        ),
  ...
  meshAdd(
    cylinder(),
    translation(-21.1 + 2.45, -3, 55).scale(2.45, 1.4, 2.7),
    material(0.9, 0.9, 0.9, 0.2)
  );
  ...
  meshAdd(
    csg_polygons_subtract(
      polygons_transform(
        cylinder(),
        translation(-100, 1, 63).scale(7.5, 4),
        material(0.5, 0.5, 0.5, 0.4)
      ),
      polygons_transform(
        cylinder(),
        translation(-100, 0, 63).scale(2, 2, 4),
        material(0.5, 0.5, 0.5, 0.4)
      ),
      polygons_transform(
        cylinder(20, 1),
  ...
  GQuad.map(({ x, z }) => {
    ...
    meshAdd(
      cylinder(6),
      translation(x * 3, 3, z * 15).scale(0.7, 4, 0.7),
      material(0.6, 0.3, 0.3, 0.4)
    );
    ...
    meshAdd(
      cylinder(6),
      translation(-100 + x * 7, -3, z * 7 + 55).scale(1, 8.1),
  ...
  integers_map(7, (i) => {
    meshAdd(
      ...
      translation(-101 + Math.sin(i) * 5 + i, -2.3 - i, 44.9 - i * 2.8).scaleSelf(
        5 + i / 2,
        1.1 + i / 6,
        5 + i / 3
      ),
  ...
  meshAdd(
    cylinder(12, 1),
    translation(-86, -9, 31).scale(1.5, 1, 1.5),
  ...
  meshAdd(
    cylinder(5),
    translation(-38.9, -11.1, 10).scale(2, 1.2, 2),
  ...
  meshAdd(
    csg_polygons_subtract(
      ...
      polygons_transform(
        cylinder(5),
        translation(-38.9, -11.1, 17).scale3d(5.4),
        material(0, 0.2, 0.3, 0.5)
      )
    )
  );
    ...
    csg_polygons_subtract(
      ...
      ...integers_map(6, (z) =>
        integers_map(6, (x) =>
          polygons_transform(
            cylinder(6),
            translation(4.6 * x - (z & 1 ? 10 : 12), 0, 4.6 * z + 2 * Math.sin(x * 4) - 32).scale3d(
              2
            ),
            material(0.7, 0.7, 0.7, 0.3)
          )
  ...
  meshAdd(
    csg_polygons_subtract(
      ...
      ...pushingRodsPositions.map((x) =>
        polygons_transform(cylinder(), translation(x, 0.05, -3).scale(1.35, 2, 9))
      )
    ),
    identity,
  ...
  meshAdd(
    cylinder(6),
    translation(-116, -2.6, -16.5).scale(3.2, 0.8, 3),
  ...
  meshAdd(
    cylinder(8).slice(0, -2),
    translation(-114, -17, -2).scale(2, 15, 2),
    material(0.6, 0.6, 0.6, 0.3)
  );

  meshAdd(
    cylinder(8).slice(0, -2),
    translation(-79, -17, -2).scale(2, 15, 2),
    material(1, 1, 1, 0.3)
  );
  meshAdd(
    cylinder().slice(0, -1),
  ...
  [-1, 1].map((x, j) => {
    ...
    meshAdd(
      csg_polygons_subtract(
        polygons_transform(
          cylinder(),
          translation(x * -4, 3.5, -0.5).scale(4, 4, 0.7),
          material(0.5, 0.5, 0.5, 0.4)
        ),
        polygons_transform(
          cylinder(5),
  ...
  const makeBigArc = (height: number) =>
    csg_polygons_subtract(
      polygons_transform(
        cylinder().slice(0, -1),
        translation(0, -height / 2).scale(6, height - 1, 2.2)
      ),
      polygons_transform(
        cylinder().slice(0, -1),
        translation(0, -height / 2 - 4).scale(4, height - 5, 4)
      ),
      polygons_transform(
        cylinder(28, 1),
  ...
  newSoul(
    translation(0, 3, 95),
    ...polygon_regular(9).map(({ x, z }): Circle => [x * 9, z * 9, 4])
  );
  ...
  meshAdd(
    cylinder(3),
    translation(-23, -1.7, 55.8).scale(5, 0.7, 8.3),
    material(0.3, 0.6, 0.6, 0.2)
  );
  meshAdd(
    cylinder(8),
    translation(-23, -2.2, 66.5).scale(1.5, 1.2, 1.5),
    material(0.8, 0.8, 0.8, 0.2)
  );
  ...
  meshAdd(
    cylinder(),
    translation(-21.1 - 1.45, -3, 55).scale(1.45, 1.4, 2.7),
    material(0.7, 0.7, 0.7, 0.2)
  );
  ...
  meshAdd(
    cylinder(5),
    translation(-38.9, -1.3, 17).scale(1.1, 3, 1.1).skewY(-20),
    material(0.3, 0.3, 0.5, 0.5)
  );
  ...
  [
    ...
    if (i === 2) {
      ...
      meshAdd(
        cylinder(),
        translation(-29.1, 0.4, 91).scale(2.1, 1, 3),
        material(0.7, 0.7, 0.7, 0.3)
      );
    }
    if (i === 1) {
  ...
  newSoul(
    translation(0, 3),
    ...polygon_regular(14).map(({ x, z }): Circle => [x * 5.6, z * 5.6, 2])
  );
  ...
  meshAdd(
    csg_polygons_subtract(
      polygons_transform(
        cylinder(28, 1).slice(0, -1),
        translation(0, 2).scale(7.5, 1, 7.5),
        material(0.35, 0, 0, 0.3)
      ),
      polygons_transform(
        cylinder().slice(0, -1),
        translation(0, 2).scale(9, 1.1, 2),
  ...
  meshAdd(
    csg_polygons_subtract(
      ...
      polygons_transform(
        cylinder().slice(0, -1),
        translation(0, 2, 7).scale(2, 1.1, 9),
        material(0.3, 0, 0, 0.3)
      ),
      polygons_transform(
        cylinder().slice(0, -1),
        translation(7, 2).scale(9, 1.1, 2),
        material(0.3, 0, 0, 0.3)
      )
    )
  );
  ...
  for (let i = 0; i < LEVERS_COUNT; ++i) {
    ...
    meshAdd(
      cylinder(6, 1).slice(0, -1),
      identity.scale(0.12, 1.2, 0.12),
      material(0.3, 0.3, 0.5, 0.1)
    );
    meshAdd(
      cylinder(3),
  ...
  [-1, 1].map((v, i) => {
    ...
    meshAdd(
      cylinder(20, 1),
      translation(0.3 * v, -0.8).scale(0.2, 0.7, 0.24),
      material(1, 0.3, 0.4)
    );
  });
