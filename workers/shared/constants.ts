...
export const SECURITY_HEADERS: Record<string, string> = {
  ...
  'Content-Security-Policy': [
    "default-src 'self'",
    "script-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net https://js.stripe.com https://challenges.cloudflare.com https://*.posthog.com https://us-assets.i.posthog.com",
    ...
    "frame-src 'self' https://*.cloudflarestream.com https://*.videodelivery.net https://js.stripe.com https://challenges.cloudflare.com https://www.youtube-nocookie.com",
...
export const GHOST_REDIRECTS: Record<string, string> = {
  ...
  '/wbc/pool/c': '/mlb',
  '/wbc/pool/d': '/mlb',
  '/wbc/editorial/pool-c-preview': '/mlb',
  '/college-baseball/preseason': '/college-baseball/editorial',
  ...
  '/baseball/rankings/': '/college-baseball/rankings',
  '/vision-AI-Intelligence': '/vision-ai',
  '/vision-AI-Intelligence/': '/vision-ai',
  '/vision-ai-intelligence': '/vision-ai',
  '/vision-ai-intelligence/': '/vision-ai',
  ...
  '/nba.html': '/nba',
  '/cfb.html': '/cfb',
  '/mlb/scores.html': '/mlb/scores',
  '/nfl/scores.html': '/nfl/scores',
  '/nba/scores.html': '/nba/scores',
  '/mlb/games.html': '/mlb/games',
  '/nfl/games.html': '/nfl/games',
  '/nba/games.html': '/nba/games',
  '/mlb/news.html': '/mlb/news',
  '/nfl/news.html': '/nfl/news',
  '/nba/news.html': '/nba/news',
  '/mlb/players.html': '/mlb/players',
  '/nfl/players.html': '/nfl/players',
  '/nba/players.html': '/nba/players',
  '/nba/teams.html': '/nba/teams',
  '/nfl/teams.html': '/nfl/teams',
