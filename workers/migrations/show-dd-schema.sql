-- Schema for bsi-show-dd-db (isolated from bsi-prod-db)
-- Migrated 2026-04-07 as part of scope-creep remediation
...
CREATE INDEX IF NOT EXISTS idx_show_card_attributes_card_time ON show_card_attributes(card_id, captured_at DESC);
CREATE INDEX IF NOT EXISTS idx_show_market_current_sell ON show_market_current(best_sell_now DESC);
CREATE INDEX IF NOT EXISTS idx_show_market_current_spread ON show_market_current(spread DESC);
CREATE INDEX IF NOT EXISTS idx_show_market_current_captured ON show_market_current(captured_at DESC);
CREATE INDEX IF NOT EXISTS idx_show_market_snapshots_card_time ON show_market_snapshots(card_id, captured_at DESC);
CREATE INDEX IF NOT EXISTS idx_show_market_daily_card_time ON show_market_daily(card_id, captured_at DESC);
