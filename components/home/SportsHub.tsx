...
const sports: SportCardData[] = [
  ...
  },
  {
    ...
    icon: FootballIcon,
    href: '/nfl',
    description: 'Live scores, standings, and team analytics for the fan who watches the whole schedule \u2014 not just primetime.',
    color: '#013369',
  },
  {
    name: 'NBA',
    icon: BasketballIcon,
    href: '/nba',
    description: 'Live scores, standings, and game analytics across all 30 teams \u2014 not just the ones on national TV.',
  ...
  },
  {
    ...
    icon: StadiumIcon,
    href: '/cfb',
    description: 'Scores, standings, and conference analytics from the SEC to the Sun Belt \u2014 every power conference and beyond.',
    color: '#D97706',
  },
];
