...
const FALLBACK_ARTICLES: Editorial[] = [
  {
    ...
    date: '2026-03-11',
    title: 'Week 5: Conference Play Opens, The Margin Gets Thinner',
    preview: 'SEC and Big 12 schedules flip live. Non-conference padding disappears. Who built something real, and who ran a mirage through February.',
    teams: [],
    wordCount: 3400,
  ...
  {
    id: 1,
    slug: 'conference-openers-what-to-watch',
    date: '2026-03-10',
    title: 'Conference Openers: What the First Weekend Tells You',
    preview: 'Rotation depth, bullpen sequencing, and lineup construction all reveal themselves differently once the schedule gets honest. Here is what to track.',
    teams: [],
    wordCount: 2800,
  ...
  {
    id: 2,
    slug: 'mid-majors-worth-watching-march',
    date: '2026-03-08',
    title: 'Mid-Majors Worth Watching in March',
    preview: 'The programs doing real work outside the power conferences — where sabermetrics show value the standings do not yet reflect.',
    teams: [],
    wordCount: 3100,
  ...
  {
    id: 3,
    slug: 'park-factors-early-read-2026',
    date: '2026-03-07',
    title: 'Park Factors: Early 2026 Read',
    preview: 'Four weeks of data is enough to see which venues are suppressing offense and which are inflating it. BSI Savant numbers updated through Week 4.',
    teams: [],
    wordCount: 2600,
