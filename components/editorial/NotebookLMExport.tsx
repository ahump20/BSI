    ...
    <div className={`text-center ${className}`}>
      {step === 'idle' && (
        <button
          ...
          className="inline-flex items-center gap-2 px-6 py-3 bg-burnt-orange hover:bg-ember text-white font-display uppercase tracking-wider text-sm rounded-sm transition-colors"
        >
