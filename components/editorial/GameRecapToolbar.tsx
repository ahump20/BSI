    ...
    <div className="sticky top-0 z-40 backdrop-blur-md bg-background-primary/80 border-b border-border">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 sm:gap-3 ml-auto">
          <button
            onClick={onOpenAI}
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-mono uppercase tracking-wider text-text-secondary hover:text-burnt-orange border border-border hover:border-burnt-orange/30 rounded-sm transition-colors"
          >
