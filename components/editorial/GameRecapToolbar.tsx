  ...
  return (
    <div className="sticky top-0 z-40 backdrop-blur-md bg-[#0D0D0D]/80 border-b border-white/10">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between gap-3">
        <span className="hidden sm:block font-mono text-[10px] uppercase tracking-widest text-[#BF5700]">
          Game Recap
        </span>
        <div className="flex items-center gap-2 sm:gap-3 ml-auto">
          <button
            onClick={onOpenAI}
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-mono uppercase tracking-wider text-white/70 hover:text-[#BF5700] border border-white/10 hover:border-[#BF5700]/30 rounded transition-colors"
          >
