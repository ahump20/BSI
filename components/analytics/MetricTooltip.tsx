...
export function MetricTooltip({
  ...
  return (
    ...
    >
      {children}
      {open && (
        <span className="absolute z-50 bottom-full left-1/2 -translate-x-1/2 mb-2 w-64 p-3 rounded-sm bg-[var(--surface-dugout)] border border-[var(--border-vintage)] shadow-xl">
