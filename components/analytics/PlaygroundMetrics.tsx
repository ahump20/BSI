...
const BATTING_CARDS: FormulaCard[] = [
  ...
  { id: 'lwr', label: 'Linear Weight Runs', formula: '0.47·1B + 0.77·2B + 1.04·3B + 1.42·HR + 0.33·BB − 0.27·Outs', description: 'Absolute run contribution estimate. Unlike rate stats, this accumulates — useful for comparing total offensive value produced.', range: '−15 to +60 per season D1', interpret: '>40 elite total offensive value', tier: 'pro' },
