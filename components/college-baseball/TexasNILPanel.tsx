  ...
  if (error || texasPlayers.length === 0) {
    return (
      <Card padding="lg" className="text-center">
        <p className="text-[rgba(196,184,165,0.35)] text-sm">NIL data unavailable for Texas players.</p>
      </Card>
    );
  }
            ...
            <tbody>
              {texasPlayers.map((p) => (
                <tr key={p.player_id} className="border-t border-[var(--border-vintage)]">
                  ...
                  <td className="py-2 px-2 text-right font-mono text-[var(--bsi-dust)] text-xs">
