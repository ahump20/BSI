      ...
      <div className="px-4 pt-4 pb-2 flex items-center justify-between">
        <span className="intel-section-label">
          <Activity
            ...
            style={{ color: 'var(--bsi-intel-accent, var(--bsi-primary))' }}
          />
          Slate
        </span>
        <span
                  ...
                  <div className="relative group">
                    ...
                    {canScrollLeft && (
                      <button
                        ...
                        className="absolute left-0 top-1/2 -translate-y-1/2 z-10 hidden sm:flex items-center justify-center w-8 h-8 rounded-full bg-black/60 text-[var(--bsi-dust)] hover:text-[var(--bsi-bone)] hover:bg-black/80 opacity-0 group-hover:opacity-100 transition-opacity -ml-3"
                    ...
                    {canScrollRight && (
                      <button
                        ...
                        className="absolute right-0 top-1/2 -translate-y-1/2 z-10 hidden sm:flex items-center justify-center w-8 h-8 rounded-full bg-black/60 text-[var(--bsi-dust)] hover:text-[var(--bsi-bone)] hover:bg-black/80 opacity-0 group-hover:opacity-100 transition-opacity -mr-3"
