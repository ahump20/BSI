    ...
    >
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          {isLive && (
            <span className="inline-flex items-center gap-1 px-1.5 py-0.5 bg-bsi-primary/15 text-bsi-primary text-[10px]" style={{ fontFamily: 'var(--intel-mono)', borderRadius: '1px' }}>
      ...
      <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-4 mb-4">
        ...
        <div className="flex items-center gap-3">
          {game.away.logo && (
            <img src={game.away.logo} alt={`${game.away.name} logo`} className="h-10 w-10 shrink-0 object-contain" loading="lazy" decoding="async" />
          )}
          <div>
        ...
        <div className="flex items-center justify-end gap-3">
          ...
          {game.home.logo && (
            <img src={game.home.logo} alt={`${game.home.name} logo`} className="h-10 w-10 shrink-0 object-contain" loading="lazy" decoding="async" />
          )}
        </div>
      </div>
