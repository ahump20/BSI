        ...
        <DataErrorBoundary name="team builder">
          {loading ? (
            <div className="grid gap-4 lg:grid-cols-[0.66fr_0.34fr]">
              <div className="h-[680px] animate-pulse rounded-xl border border-[var(--border-vintage)] bg-[var(--surface-dugout)]" />
              <div className="h-[680px] animate-pulse rounded-xl border border-[var(--border-vintage)] bg-[var(--surface-dugout)]" />
            </div>
          ) : reference ? (
            <div className="grid gap-4 lg:grid-cols-[0.66fr_0.34fr]">
              <Card padding="lg">
                ...
                <CardContent className="space-y-6 px-0 pb-0 pt-4">
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <div className="flex items-end">
                      <button
                        ...
                        className="rounded-full border border-burnt-orange bg-burnt-orange/15 px-4 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-burnt-orange disabled:opacity-50"
                      >
                  ...
                  {savedBuild ? (
                    <div className="rounded-xl border border-burnt-orange/35 bg-burnt-orange/10 px-4 py-4 text-sm text-[var(--bsi-bone)]">
                                ...
                                {selection ? (
                                  <div className="mt-3 grid gap-3 md:grid-cols-2">
                                    <select
                                      ...
                                      className="rounded-lg border border-[var(--border-vintage)] bg-[var(--surface-scoreboard)] px-3 py-2 text-xs text-[var(--bsi-bone)]"
                                    >
              ...
              <div className="space-y-4">
                <Card padding="lg">
                  ...
                  <CardContent className="space-y-4 px-0 pb-0 pt-4">
                    ...
                    {captainCard ? (
                      <div className="rounded-xl border border-[var(--border-vintage)] bg-[var(--surface-dugout)] px-4 py-4 text-sm text-[var(--bsi-dust)]">
                    ...
                    {searchLoading ? (
                      ...
                      <div className="space-y-3">
                        {results.cards.map((card) => (
                          <div
                            key={card.id}
                            className="rounded-lg border border-[var(--border-vintage)] bg-[var(--surface-dugout)] px-4 py-4"
                          >
                            <div className="flex items-center justify-between gap-4">
                              <div>
                            ...
                            <button
                              ...
                              className="mt-3 rounded-full border border-burnt-orange bg-burnt-orange/15 px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-burnt-orange"
                            >
                              Assign card
                            </button>
                          </div>
