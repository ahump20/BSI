      ...
      <main className="basketball-main" role="main">
        <div className="content-container">
          ...
          {activeView === 'scores' && (
            <section className="scores-section" role="tabpanel" aria-label="Live scores">
              ...
              <div className="scores-grid" role="list" aria-label="Basketball games">
                {/* Game Card 1 */}
                <article className="game-card" role="listitem" aria-label="Kentucky at Tennessee, Final, Tennessee won 82 to 78">
                  <div className="game-status" role="status">Final</div>
                  <div className="game-teams" role="group" aria-label="Teams and scores">
                    <div className="team away-team" role="group" aria-label="Away team: Kentucky, 78 points">
                      <span className="team-name">Kentucky</span>
                      <span className="team-score" aria-label="Score: 78">78</span>
                    </div>
                    <div className="game-divider" aria-hidden="true">@</div>
                    <div className="team home-team winner" role="group" aria-label="Home team: Tennessee, 82 points, winner">
                      <span className="team-name">Tennessee</span>
                      <span className="team-score" aria-label="Score: 82">82</span>
                    </div>
                  </div>
                ...
                {/* Game Card 2 */}
                <article className="game-card" role="listitem" aria-label="Duke at North Carolina, Live, 2nd Half, North Carolina leading 48 to 45">
                  <div className="game-status live" role="status" aria-live="polite">Live - 2nd Half</div>
                  <div className="game-teams" role="group" aria-label="Teams and scores">
                    <div className="team away-team" role="group" aria-label="Away team: Duke, 45 points">
                      <span className="team-name">Duke</span>
                      <span className="team-score" aria-label="Score: 45">45</span>
                    </div>
                    <div className="game-divider" aria-hidden="true">@</div>
                    <div className="team home-team" role="group" aria-label="Home team: North Carolina, 48 points">
                      <span className="team-name">North Carolina</span>
                      <span className="team-score" aria-label="Score: 48">48</span>
                    </div>
                  </div>
                  <div className="game-info" role="group" aria-label="Game details">
                ...
                {/* Game Card 3 */}
                <article className="game-card" role="listitem" aria-label="Kansas at Texas, Final, Kansas won 89 to 85">
                  <div className="game-status" role="status">Final</div>
                  <div className="game-teams" role="group" aria-label="Teams and scores">
                    <div className="team away-team winner" role="group" aria-label="Away team: Kansas, 89 points, winner">
                      <span className="team-name">Kansas</span>
                      <span className="team-score" aria-label="Score: 89">89</span>
                    </div>
                    <div className="game-divider" aria-hidden="true">@</div>
                    <div className="team home-team" role="group" aria-label="Home team: Texas, 85 points">
                      <span className="team-name">Texas</span>
                      <span className="team-score" aria-label="Score: 85">85</span>
                    </div>
                  </div>
                  <div className="game-info" role="group" aria-label="Game details">
          ...
          {activeView === 'standings' && (
            <section className="standings-section" role="tabpanel" aria-label="Conference standings">
              <h3 className="section-title">Conference Standings</h3>

              <div className="conference-standings">
                <h4 className="conference-name">SEC</h4>
                <table className="standings-table" role="table" aria-label="SEC conference standings">
                  <thead>
                    <tr>
                  ...
                  <tbody>
                    <tr>
                      <td className="team-cell" scope="row">
                        <span className="rank" aria-label="Rank 1">1</span>
                        Tennessee
                      </td>
                    ...
                    <tr>
                      <td className="team-cell" scope="row">
                        <span className="rank" aria-label="Rank 2">2</span>
                        Kentucky
                      </td>
                    ...
                    <tr>
                      <td className="team-cell" scope="row">
                        <span className="rank" aria-label="Rank 3">3</span>
                        Auburn
                      </td>
                    ...
                    <tr>
                      <td className="team-cell" scope="row">
                        <span className="rank" aria-label="Rank 4">4</span>
                        Texas A&M
                      </td>
              ...
              <div className="conference-standings">
                ...
                <table className="standings-table" role="table" aria-label="Big 12 conference standings">
                  <thead>
                    <tr>
                      <th scope="col">Team</th>
                      <th scope="col">Conf</th>
                ...
                <div className="stat-category" role="region" aria-label="Points per game leaders">
                  ...
                  <ol className="stat-list" role="list">
                    <li role="listitem" aria-label="Zach Edey, Purdue, 24.5 points per game">
                      ...
                      <span className="stat-value" aria-label="24.5 points per game">24.5</span>
                    </li>
                    <li role="listitem" aria-label="Hunter Dickinson, Kansas, 23.8 points per game">
                      ...
                      <span className="stat-value" aria-label="23.8 points per game">23.8</span>
                    </li>
                    <li role="listitem" aria-label="Tyler Kolek, Marquette, 22.1 points per game">
                      ...
                      <span className="stat-value" aria-label="22.1 points per game">22.1</span>
                    </li>
                  </ol>
                </div>
                ...
                <div className="stat-category" role="region" aria-label="Rebounds per game leaders">
                  ...
                  <ol className="stat-list" role="list">
                    <li role="listitem" aria-label="Zach Edey, Purdue, 12.4 rebounds per game">
                      <span className="player-name">Zach Edey</span>
                      <span className="player-team">Purdue</span>
                      <span className="stat-value" aria-label="12.4 rebounds per game">12.4</span>
                    </li>
                    <li role="listitem" aria-label="Ryan Kalkbrenner, Creighton, 11.8 rebounds per game">
                      <span className="player-name">Ryan Kalkbrenner</span>
                      <span className="player-team">Creighton</span>
                      <span className="stat-value" aria-label="11.8 rebounds per game">11.8</span>
                    </li>
                    <li role="listitem" aria-label="Coleman Hawkins, Illinois, 10.9 rebounds per game">
                      <span className="player-name">Coleman Hawkins</span>
                      <span className="player-team">Illinois</span>
                      <span className="stat-value" aria-label="10.9 rebounds per game">10.9</span>
                    </li>
                  </ol>
                </div>
                ...
                <div className="stat-category" role="region" aria-label="Assists per game leaders">
                  ...
                  <ol className="stat-list" role="list">
                    <li role="listitem" aria-label="Tyler Kolek, Marquette, 8.7 assists per game">
                      <span className="player-name">Tyler Kolek</span>
                      <span className="player-team">Marquette</span>
                      <span className="stat-value" aria-label="8.7 assists per game">8.7</span>
                    </li>
                    <li role="listitem" aria-label="Braden Smith, Purdue, 7.9 assists per game">
                      <span className="player-name">Braden Smith</span>
                      <span className="player-team">Purdue</span>
                      <span className="stat-value" aria-label="7.9 assists per game">7.9</span>
                    </li>
                    <li role="listitem" aria-label="Caleb Love, Arizona, 7.5 assists per game">
                      ...
                      <span className="stat-value" aria-label="7.5 assists per game">7.5</span>
                    </li>
                  </ol>
                </div>
              </div>
