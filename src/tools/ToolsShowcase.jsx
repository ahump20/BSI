...
const ToolsShowcase = () => {
  const tools = [
    ...
    },
    {
      ...
      description:
        'Monte Carlo game simulator with live probability curves. Input any matchup to get win probability distribution, expected margin, and upset likelihood. Pitch-by-pitch model for college baseball—no competitor offers this level of granularity.',
      icon: '📊',
    ...
    },
    {
      ...
      description:
        'ML models that predict trajectory and injury risk for college prospects. Searchable database with development curves, MLB draft projections, and injury risk scores based on workload and biomechanics. Surfaces intelligence for under-covered programs.',
      icon: '🎯',
    ...
    },
    {
      ...
      description:
        'Mobile notification system with game updates, roster moves, injuries, and recruiting commits. Customize by team, sport, and alert type. Connects to our Trend and Highlights Analyzer for automated content generation with editorial voice. Time-stamped in America/Chicago.',
      icon: '🔔',
        ...
        <section className="coverage-gap-section">
          ...
          <div className="gap-highlights">
            ...
            <div className="gap-card">
              ...
              <p>
                Mainstream recruiting sites focus on Power 5 conferences. Our Cross-Sport Recruiting
                Tracker (#4) highlights Group of Five and FCS programs, providing equal visibility
                to under-covered talent pipelines.
              </p>
            </div>
            <div className="gap-card">
